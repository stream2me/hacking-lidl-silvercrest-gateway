/***************************************************************************//**
 * @file main.c
 * @brief main() function for Zigbee 3.0 Router firmware
 *******************************************************************************
 * Router firmware for EFR32MG1B232F256GM48 with RTL8196E boot delay
 ******************************************************************************/
...
int main(void)
{
  ...
  // starts communicating. Without this delay, early messages may be lost.
