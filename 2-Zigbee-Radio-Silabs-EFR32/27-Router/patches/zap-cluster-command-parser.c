...
// Signature for TerminateKeyEstablishment command
static const sl_signature_t sig_key_establishment_cluster_terminate_key_establishment_command = sl_zcl_key_establishment_cluster_terminate_key_establishment_command_signature;
// Command parser for TerminateKeyEstablishment command
EmberAfStatus zcl_decode_key_establishment_cluster_terminate_key_establishment_command (EmberAfClusterCommand * cmd, sl_zcl_key_establishment_cluster_terminate_key_establishment_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_key_establishment_cluster_terminate_key_establishment_command, (uint8_t*)cmd_struct);
} 
...
// Signature for GetLastNetworkProvisioningResult command
static const sl_signature_t sig_network_provisioning_cluster_get_last_network_provisioning_result_command = sl_zcl_network_provisioning_cluster_get_last_network_provisioning_result_command_signature;
// Command parser for GetLastNetworkProvisioningResult command
EmberAfStatus zcl_decode_network_provisioning_cluster_get_last_network_provisioning_result_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_get_last_network_provisioning_result_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_get_last_network_provisioning_result_command, (uint8_t*)cmd_struct);
} 
...
// Signature for SayHelloFromClient command
static const sl_signature_t sig_demo_cluster_say_hello_from_client_command = sl_zcl_demo_cluster_say_hello_from_client_command_signature;
// Command parser for SayHelloFromClient command
EmberAfStatus zcl_decode_demo_cluster_say_hello_from_client_command (EmberAfClusterCommand * cmd, sl_zcl_demo_cluster_say_hello_from_client_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_demo_cluster_say_hello_from_client_command, (uint8_t*)cmd_struct);
} 
...
// Signature for AddWiFiNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_add_wi_fi_network_resp_command = sl_zcl_network_provisioning_cluster_add_wi_fi_network_resp_command_signature;
// Command parser for AddWiFiNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_add_wi_fi_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_add_wi_fi_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_add_wi_fi_network_resp_command, (uint8_t*)cmd_struct);
} 


// Signature for UpdateWiFiNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_update_wi_fi_network_resp_command = sl_zcl_network_provisioning_cluster_update_wi_fi_network_resp_command_signature;
// Command parser for UpdateWiFiNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_update_wi_fi_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_update_wi_fi_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_update_wi_fi_network_resp_command, (uint8_t*)cmd_struct);
} 


// Signature for AddThreadNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_add_thread_network_resp_command = sl_zcl_network_provisioning_cluster_add_thread_network_resp_command_signature;
// Command parser for AddThreadNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_add_thread_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_add_thread_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_add_thread_network_resp_command, (uint8_t*)cmd_struct);
} 


// Signature for UpdateThreadNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_update_thread_network_resp_command = sl_zcl_network_provisioning_cluster_update_thread_network_resp_command_signature;
// Command parser for UpdateThreadNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_update_thread_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_update_thread_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_update_thread_network_resp_command, (uint8_t*)cmd_struct);
} 


// Signature for RemoveNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_remove_network_resp_command = sl_zcl_network_provisioning_cluster_remove_network_resp_command_signature;
// Command parser for RemoveNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_remove_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_remove_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_remove_network_resp_command, (uint8_t*)cmd_struct);
} 


// Signature for EnableNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_enable_network_resp_command = sl_zcl_network_provisioning_cluster_enable_network_resp_command_signature;
// Command parser for EnableNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_enable_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_enable_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_enable_network_resp_command, (uint8_t*)cmd_struct);
} 


// Signature for DisableNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_disable_network_resp_command = sl_zcl_network_provisioning_cluster_disable_network_resp_command_signature;
// Command parser for DisableNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_disable_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_disable_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_disable_network_resp_command, (uint8_t*)cmd_struct);
} 


// Signature for TestNetworkResp command
static const sl_signature_t sig_network_provisioning_cluster_test_network_resp_command = sl_zcl_network_provisioning_cluster_test_network_resp_command_signature;
// Command parser for TestNetworkResp command
EmberAfStatus zcl_decode_network_provisioning_cluster_test_network_resp_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_test_network_resp_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_test_network_resp_command, (uint8_t*)cmd_struct);
} 
...
// Signature for TransferApdu command
static const sl_signature_t sig_iso_7816_protocol_tunnel_cluster_transfer_apdu_command = sl_zcl_iso_7816_protocol_tunnel_cluster_transfer_apdu_command_signature;
// Command parser for TransferApdu command
EmberAfStatus zcl_decode_iso_7816_protocol_tunnel_cluster_transfer_apdu_command (EmberAfClusterCommand * cmd, sl_zcl_iso_7816_protocol_tunnel_cluster_transfer_apdu_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_iso_7816_protocol_tunnel_cluster_transfer_apdu_command, (uint8_t*)cmd_struct);
} 
...
// Signature for ScanNetworks command
static const sl_signature_t sig_network_provisioning_cluster_scan_networks_command = sl_zcl_network_provisioning_cluster_scan_networks_command_signature;
// Command parser for ScanNetworks command
EmberAfStatus zcl_decode_network_provisioning_cluster_scan_networks_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_scan_networks_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_scan_networks_command, (uint8_t*)cmd_struct);
} 


// Signature for AddThreadNetwork command
static const sl_signature_t sig_network_provisioning_cluster_add_thread_network_command = sl_zcl_network_provisioning_cluster_add_thread_network_command_signature;
// Command parser for AddThreadNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_add_thread_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_add_thread_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_add_thread_network_command, (uint8_t*)cmd_struct);
} 


// Signature for UpdateThreadNetwork command
static const sl_signature_t sig_network_provisioning_cluster_update_thread_network_command = sl_zcl_network_provisioning_cluster_update_thread_network_command_signature;
// Command parser for UpdateThreadNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_update_thread_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_update_thread_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_update_thread_network_command, (uint8_t*)cmd_struct);
} 


// Signature for RemoveNetwork command
static const sl_signature_t sig_network_provisioning_cluster_remove_network_command = sl_zcl_network_provisioning_cluster_remove_network_command_signature;
// Command parser for RemoveNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_remove_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_remove_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_remove_network_command, (uint8_t*)cmd_struct);
} 


// Signature for EnableNetwork command
static const sl_signature_t sig_network_provisioning_cluster_enable_network_command = sl_zcl_network_provisioning_cluster_enable_network_command_signature;
// Command parser for EnableNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_enable_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_enable_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_enable_network_command, (uint8_t*)cmd_struct);
} 


// Signature for DisableNetwork command
static const sl_signature_t sig_network_provisioning_cluster_disable_network_command = sl_zcl_network_provisioning_cluster_disable_network_command_signature;
// Command parser for DisableNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_disable_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_disable_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_disable_network_command, (uint8_t*)cmd_struct);
} 


// Signature for TestNetwork command
static const sl_signature_t sig_network_provisioning_cluster_test_network_command = sl_zcl_network_provisioning_cluster_test_network_command_signature;
// Command parser for TestNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_test_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_test_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_test_network_command, (uint8_t*)cmd_struct);
} 


// Signature for AddWiFiNetwork command
static const sl_signature_t sig_network_provisioning_cluster_add_wi_fi_network_command = sl_zcl_network_provisioning_cluster_add_wi_fi_network_command_signature;
// Command parser for AddWiFiNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_add_wi_fi_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_add_wi_fi_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_add_wi_fi_network_command, (uint8_t*)cmd_struct);
} 


// Signature for UpdateWiFiNetwork command
static const sl_signature_t sig_network_provisioning_cluster_update_wi_fi_network_command = sl_zcl_network_provisioning_cluster_update_wi_fi_network_command_signature;
// Command parser for UpdateWiFiNetwork command
EmberAfStatus zcl_decode_network_provisioning_cluster_update_wi_fi_network_command (EmberAfClusterCommand * cmd, sl_zcl_network_provisioning_cluster_update_wi_fi_network_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_network_provisioning_cluster_update_wi_fi_network_command, (uint8_t*)cmd_struct);
} 
...
// Command parser for ScanNetworksResp command
...
1u)
  {
    return EMBER_ZCL_STATUS_MALFORMED_COMMAND;
        ...
        cmd_struct->ErrorCode = sli_decode_parse_one_byte(cmd, payloadOffset);
  ...
  if (cmd->bufLen < payloadOffset + emberAfStringLength(cmd->buffer + payloadOffset) + 1u)
  {
    return EMBER_ZCL_STATUS_MALFORMED_COMMAND;
        ...
        cmd_struct->DebugText = sli_decode_string(cmd, payloadOffset);


        payloadOffset+= emberAfStringLength(cmd->buffer + payloadOffset) + 1u;
    cmd_struct->WiFiScanResults = cmd->buffer + payloadOffset;
    cmd_struct->ThreadScanResults = cmd->buffer + payloadOffset;
  return EMBER_ZCL_STATUS_SUCCESS;
} 
