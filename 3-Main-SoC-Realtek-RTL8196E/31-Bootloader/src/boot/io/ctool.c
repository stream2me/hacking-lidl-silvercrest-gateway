...
*/ 
    ...
    void
GetLine(char *buffer, const unsigned int size, int EchoFlag)  { char ch = 0;
...
*/ 
    int
Hex2Val(char *HexStr, unsigned long *PVal)  { unsigned char *ptrb;
