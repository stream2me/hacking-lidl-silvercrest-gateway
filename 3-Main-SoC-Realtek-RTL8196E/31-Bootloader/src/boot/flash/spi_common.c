...
/* Progress tracking for flash write operations */
static unsigned int flash_progress_current;
static unsigned int flash_progress_total;
static unsigned int flash_progress_last_percent;
...
/****************************************** Micronix Flash ******************************************/ 
//#define MX25L1605D            0x00C22015
	{0x00C22015, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "MX25L1605D", 50 
	 , ComSrlCmd_SE, mxic_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 }, 
//#define MX25L3205D            0x00C22016 50MHZ
//#define MX25L3206E            0x00C22016 86MHZ
	{0x00C22016, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "MX25L3205D", 50 
	 , ComSrlCmd_SE, mxic_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 }, 
//#define MX25L6405D            0x00C22017
	{0x00C22017, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "MX25L6405D", 50 
	 , ComSrlCmd_SE, mxic_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 }, 
//#define MX25L12805D           0x00C22018
	{0x00C22018, 0x00, SIZEN_16M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "MX25L12805D", 50 
	 , ComSrlCmd_SE, mxic_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 }, 
//#define MX25L1635D            0x00C22415
	{0x00C22415, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "MX25L1635D", 75 
	 , ComSrlCmd_SE, mxic_cmd_read_q1, mxic_spi_setQEBit,
	 mxic_cmd_write_q1 
	 }, 
//#define MX25L3235D            0x00C25E16
	{0x00C25E16, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "MX25L3235D", 75 
	 , ComSrlCmd_SE, mxic_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 },  
///#define Micro                0x0020ba17
	{0x0020ba17, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B, "MCba17",
	 50 
	 , ComSrlCmd_SE, mxic_cmd_read_q1, mxic_spi_setQEBit,
	 mxic_cmd_write_q1 
	 }, 
...
/****************************************** Spanson Flash ******************************************/ 
//#define S25FL016A             0x00010214
	{0x00010214, 0x00, SIZEN_02M, SIZE_064K, SIZE_064K, SIZE_256B,
	 "S25FL016A", 50 
	 , ComSrlCmd_BE, span_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 span_cmd_write_s1 
	 }, 
//#define S25FL032A             0x00010215
//#define S25FL032P             0x00010215
	{0x00010215, 0x00, SIZEN_04M, SIZE_064K, SIZE_064K, SIZE_256B,
	 "S25FL032A", 50 
	 , ComSrlCmd_BE, span_cmd_read_q0, span_spi_setQEBit,
	 span_cmd_write_q0 
	 }, 
//#define S25FL004A             0x00010212
//#define S25FL064A             0x00010216
	{0x00010216, 0x00, SIZEN_08M, SIZE_064K, SIZE_064K, SIZE_256B,
	 "S25FL064P", 80 
	 , ComSrlCmd_BE, span_cmd_read_q0, span_spi_setQEBit,
	 span_cmd_write_q0 
	 }, 
...
/****************************************** Eon Flash ******************************************/ 
//#define EN25F16                       0x001c3115
	{0x001c3115, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "EN25F16", 50 
	 , ComSrlCmd_SE, eon_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 eon_cmd_write_s1 
	 }, 
//#define EN25F32                       0x001c3116
	{0x001c3116, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "EN25F32", 104 
	 , ComSrlCmd_SE, eon_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 eon_cmd_write_s1 
	 }, 
//#define EN25Q16                       0x001c3015
	{0x001c3015, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "EN25Q16", 80 
	 , ComSrlCmd_SE, eon_cmd_read_q1, ComSrlCmd_NoneQeBit,
	 eon_cmd_write_s1 
	 }, 
//#define EN25Q32                       0x001c3016
	{0x001c3016, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "EN25Q32", 80 
	 , ComSrlCmd_SE, eon_cmd_read_q1, ComSrlCmd_NoneQeBit,
	 eon_cmd_write_s1 
	 },  
...
//#define SST25VF032B           0x00BF254A
	{0x00BF254A, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "SST25VF032B", 40 
	 , ComSrlCmd_SE, sst_cmd_read_s1, ComSrlCmd_NoneQeBit,
	 sst_cmd_write_s1 
	 }, 
//#define SST26VF032            0x00BF2602
//#define SST26VF016            0x00BF2601
...
/*20120302 Note:GD25Q8 set to 120MHZ will cause unstable*/ 
	{0x00c84014, 0x00, SIZEN_01M, SIZE_064K, SIZE_004K, SIZE_256B, "GD25Q8",
	 80 
	 , ComSrlCmd_SE, gd_cmd_read_q0, gd_spi_setQEBit, gd_cmd_write_s1 
	 }, 
//#define GD25Q16                       0x00c84015
	{0x00c84015, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "GD25Q16", 80 
	 , ComSrlCmd_SE, gd_cmd_read_q0, gd_spi_setQEBit, gd_cmd_write_s1 
	 }, 
//#define GD25Q32                       0x00c84016
	{0x00c84016, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "GD25Q32", 80 
	 , ComSrlCmd_SE, gd_cmd_read_q0, gd_spi_setQEBit, gd_cmd_write_s1 
	 }, 
//#define GD25Q64                       0x00c84017
	{0x00c84017, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "GD25Q64", 80 
	 , ComSrlCmd_SE, gd_cmd_read_q0, gd_spi_setQEBit, gd_cmd_write_s1 
	 }, 
//#define GD25Q128                      0x00c84018
	{0x00c84018, 0x00, SIZEN_16M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "GD25Q128", 84 
	 , ComSrlCmd_SE, gd_cmd_read_q0, gd_spi_setQEBit, gd_cmd_write_s1 
	 },  
/****************************************** WinBond Flash ******************************************/ 
//#define W25Q16                        0x00EF4015
	{0x00EF4015, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B, "W25Q16",
	 80 
	 , ComSrlCmd_SE, wb_cmd_read_q0, wb_spi_setQEBit, wb_cmd_write_q0 
	 }, 
//#define W25Q32                        0x00EF4016
	{0x00EF4016, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B, "W25Q32",
	 80 
	 , ComSrlCmd_SE, wb_cmd_read_q0, wb_spi_setQEBit, wb_cmd_write_q0 
	 }, 
//#define W25Q64                        0x00EF4017
	{0x00EF4017, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B, "W25Q64",
	 80 
	 , ComSrlCmd_SE, wb_cmd_read_q0, wb_spi_setQEBit, wb_cmd_write_q0 
	 }, 
//#define W25Q128                       0x00EF4018
	{0x00EF4018, 0x00, SIZEN_16M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "W25Q128", 80 
	 , ComSrlCmd_SE, wb_cmd_read_q0, wb_spi_setQEBit, wb_cmd_write_q0 
	 }, 
//#define W25X16                        0x00EF3015
	{0x00EF3015, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B, "W25X16",
	 75 
	 , ComSrlCmd_SE, at_cmd_read_d0, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 }, 
//#define W25X32                        0x00EF3016
	{0x00EF3016, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B, "W25X32",
	 75 
	 , ComSrlCmd_SE, at_cmd_read_d0, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 }, 
//#define W25X64                        0x00EF3017
	{0x00EF3016, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B, "W25X64",
	 75 
	 , ComSrlCmd_SE, at_cmd_read_d0, ComSrlCmd_NoneQeBit,
	 mxic_cmd_write_s1 
	 }, 
/****************************************** ATMEL Flash ******************************************/ 
//#define AT25DF161             0x001f4602
	{0x001f4602, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B,
	 "AT25DF161", 85 
...
// spi flash probe
    void
spi_regist(unsigned char ucChip)  { unsigned int ui, i, uiCount;
	unsigned char pucBuffer[4];
	 ui = ComSrlCmd_RDID(ucChip, 4);
	ui = ComSrlCmd_RDID(ucChip, 4);
	ui = ui >> 8;
	 uiCount =
	    sizeof (spi_flash_registed) / sizeof (struct spi_flash_known);
	 for (i = 0; i < uiCount; i++)
		 {
		if ((spi_flash_registed[i].uiChipId == ui)
		     && (spi_flash_registed[i].uiDistinguish == 0x00))
			 {
			break;
			}
		}
	if (i == uiCount)
		...
		set_flash_info(ucChip, ui, SIZEN_04M, SIZE_064K, SIZE_004K,
				SIZE_256B, "UNKNOWN", ComSrlCmd_SE,
	...
	else
		 {
		    ...
		    set_flash_info(ucChip, ui,
				   spi_flash_registed[i].uiCapacityId,
				   spi_flash_registed[i].uiBlockSize,
				   spi_flash_registed[i].uiSectorSize,
				   spi_flash_registed[i].uiPageSize,
				   spi_flash_registed[i].pcChipName,
				   spi_flash_registed[i].pfErase,
				   spi_flash_registed[i].pfRead,
				   spi_flash_registed[i].pfQeBit,
...
// set spi_flash_info struction content
    void
set_flash_info(unsigned char ucChip, unsigned int chip_id,
	       ...
	       FUNC_PAGEWRITE pfPageWrite)  { unsigned int ui =
	    1 << device_cap;
	...
	spi_flash_info[ucChip].pfPageWrite = pfPageWrite;
	    ...
	    LDEBUG
	    ("set_flash_info: ucChip=%x; chip_id=%x; device_cap=%x; block_size=%x; sector_size=%x; page_size=%x; chip_name=%s\n",
...
// get Dram Frequence
    unsigned int
CheckDramFreq(void)		//JSW:For 8196C
{
...
// Set FSCR register
    void
setFSCR(unsigned char ucChip, unsigned int uiClkMhz, unsigned int uiRBO,
	unsigned int uiWBO, unsigned int uiTCS)  { unsigned int ui, uiClk;
	uiClk = CheckDramFreq();
	ui = uiClk / uiClkMhz;
	if ((uiClk % uiClkMhz) > 0)
		 {
	...
	SPI_REG_LOAD(SFCR,
		      SFCR_SPI_CLK_DIV((ui -
					2) /
				       2) | SFCR_RBO(uiRBO) | SFCR_WBO(uiWBO) |
		      SFCR_SPI_TCS(uiTCS));
	LDEBUG
	    ("setFSCR:uiClkMhz=%d, uiRBO=%d, uiWBO=%d, uiTCS=%d, resMhz=%d, vale=%8x\n",
...
// Calculate write address group
    void
calAddr(unsigned int uiStart, unsigned int uiLenth, unsigned int uiSectorSize,
	unsigned int *uiStartAddr, unsigned int *uiStartLen,
	unsigned int *uiSectorAddr, unsigned int *uiSectorCount,
	unsigned int *uiEndAddr, unsigned int *uiEndLen)  { unsigned int ui;
	
	    // only one sector
	    if ((uiStart + uiLenth) <
		((uiStart / uiSectorSize + 1) * uiSectorSize))
		 {		// start        
		*uiStartAddr = uiStart;
		*uiStartLen = uiLenth;
		...
		*uiSectorCount = ui / uiSectorSize;
		    ...
		    //end
		    *uiEndAddr =
		    *uiSectorAddr + (*uiSectorCount * uiSectorSize);
		*uiEndLen = ui % uiSectorSize;
		}
	LDEBUG
	    ("calAddr:uiStart=%x; uiSectorSize=%x; uiLenth=%x;-> uiStartAddr=%x; uiStartLen=%x; uiSectorAddr=%x; uiSectorCount=%x; uiEndAddr=%x; uiEndLen=%x;\n",
...
// Calculate chip capacity shift bit 
    unsigned char
calShift(unsigned char ucCapacityId, unsigned char ucChipSize) 
    { unsigned int ui;
...
// Print spi_flash_type
    void
prnFlashInfo(unsigned char ucChip, struct spi_flash_type sftInfo)  {
	NDEBUG("SPI Flash: %s (%dMB)\n",
		sftInfo.chip_name, sftInfo.chip_size / (1024 * 1024));
} 
...
// Check WIP bit
    unsigned int
spiFlashReady(unsigned char ucChip)  { unsigned int uiCount, ui;
	uiCount = 0;
	while (1)
		 {
		uiCount++;
...
//toggle CS
    void
rstSPIFlash(unsigned char ucChip)  { SFCSR_CS_L(ucChip, 0, IOWIDTH_SINGLE);
...
// set cs high
    void
SFCSR_CS_L(unsigned char ucChip, unsigned char ucLen, unsigned char ucIOWidth) 
...
// set cs low
    void
SFCSR_CS_H(unsigned char ucChip, unsigned char ucLen, unsigned char ucIOWidth) 
...
// Read Identification (RDID) Sequence (Command 9F)
    unsigned int
ComSrlCmd_RDID(unsigned char ucChip, unsigned int uiLen)  { unsigned int ui;
	...
	SFCSR_CS_H(ucChip, 0, IOWIDTH_SINGLE);
	LDEBUG
	    ("ComSrlCmd_RDID: ucChip=%x; uiLen=%x; returnValue=%x; SPICMD_RDID=%x;\n",
...
// One byte Command
    void
SeqCmd_Order(unsigned char ucChip, unsigned char ucIOWidth,
	     unsigned int uiCmd)  {
...
// One byte Command Write
    void
SeqCmd_Write(unsigned char ucChip, unsigned char ucIOWidth, unsigned int uiCmd,
	     unsigned int uiValue,
	     unsigned char ucValueLen)  { SFCSR_CS_L(ucChip, DATA_LENTH1,
						       ucIOWidth);
	SPI_REG_LOAD(SFDR, uiCmd);
	...
	LDEBUG
	    ("SeqCmd_Write: ucChip=%x; ucIOWidth=%x; uiCmd=%x; uiValue=%x; ucValueLen=%x;\n",
	     ucChip, ucIOWidth, uiCmd, uiValue, ucValueLen);
} 

// One byte Command Read
    unsigned int
SeqCmd_Read(unsigned char ucChip, unsigned char ucIOWidth, unsigned int uiCmd,
	    unsigned char ucRDLen)  { unsigned int ui;
	...
	ui = ui >> ((4 - ucRDLen) * 8);
	LDEBUG
	    ("SeqCmd_Read: ucChip=%x; ucIOWidth=%x; uiCmd=%x; ucRDLen=%x; RetVal=%x\n",
...
// Sector Erase (SE) Sequence (Command 20)
    unsigned int
ComSrlCmd_SE(unsigned char ucChip, unsigned int uiAddr) 
    { SeqCmd_Order(ucChip, IOWIDTH_SINGLE, SPICMD_WREN);
	SeqCmd_Write(ucChip, IOWIDTH_SINGLE, SPICMD_SE, uiAddr, 3);
	KDEBUG
	    ("ComSrlCmd_SE: ucChip=%x; uiSector=%x; uiSectorSize=%x; SPICMD_SE=%x\n",
...
// Block Erase (BE) Sequence (Command D8)
    unsigned int
ComSrlCmd_BE(unsigned char ucChip, unsigned int uiAddr) 
    { SeqCmd_Order(ucChip, IOWIDTH_SINGLE, SPICMD_WREN);
	SeqCmd_Write(ucChip, IOWIDTH_SINGLE, SPICMD_BE, uiAddr, 3);
	KDEBUG
	    ("ComSrlCmd_BE: ucChip=%x; uiBlock=%x; uiBlockSize=%x; SPICMD_BE=%x\n",
...
// Chip Erase (CE) Sequence (Command 60 or C7)
    unsigned int
ComSrlCmd_CE(unsigned char ucChip) 
    { SeqCmd_Order(ucChip, IOWIDTH_SINGLE, SPICMD_WREN);
...
// without QE bit
    unsigned int
ComSrlCmd_NoneQeBit(unsigned char ucChip) 
...
// ucIsFast: = 0 cmd, address, dummy single IO ; =1 cmd single IO, address and dummy multi IO; =2 cmd, address and dummy multi IO;
    void
ComSrlCmd_InputCommand(unsigned char ucChip, unsigned int uiAddr,
		       unsigned int uiCmd, unsigned char ucIsFast,
		       unsigned char ucIOWidth,
		       unsigned char ucDummyCount)  { int i;
	LDEBUG
	    ("ComSrlCmd_InputCommand: ucChip=%x; uiAddr=%x; uiCmd=%x; uiIsfast=%x; ucIOWidth=%x; ucDummyCount=%x\n",
...
// Set SFCR2 for memery map read
    unsigned int
SetSFCR2(unsigned int uiCmd, unsigned char ucIsFast, unsigned char ucIOWidth,
	 unsigned char ucDummyCount)  { unsigned int ui, uiDy;
	ucSFCR2 = 0;
	ui =
	    SFCR2_SFCMD(uiCmd) | SFCR2_SFSIZE(spi_flash_info[0].device_size -
					      17) | SFCR2_RD_OPT(0) |
	    SFCR2_HOLD_TILL_SFDR2(0);
	switch (ucIsFast)
		 {
	case ISFAST_NO:
		 {
			ui =
			    ui | SFCR2_CMD_IO(IOWIDTH_SINGLE) |
			    SFCR2_ADDR_IO(IOWIDTH_SINGLE) |
	...
	LDEBUG
	    ("SetSFCR2: uiCmd=%x; ucIsFast=%; ucIOWidth=%x; ucDummyCount=%x; ucSFCR2=%x; SFCR2=%x\n;",
...
// read template
    unsigned int
ComSrlCmd_ComRead(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		  unsigned char *pucBuffer, unsigned int uiCmd,
		  unsigned char ucIsFast, unsigned char ucIOWidth,
		  unsigned char ucDummyCount)  {  unsigned int ui, uiCount,
	    i;
	unsigned char *puc = pucBuffer;
	LDEBUG
	    ("ComSrlCmd_ComRead: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; uiCmd=%x; uiIsfast=%x; ucIOWidth=%x; ucDummyCount=%x\n",
	...
	{
		ui =
		    SetSFCR2((uiCmd >> 24), ucIsFast, ucIOWidth, ucDummyCount);
	}
	 uiCount = uiLen / 4;
...
// write template
    unsigned int
ComSrlCmd_ComWrite(unsigned char ucChip, unsigned int uiAddr,
		   unsigned int uiLen, unsigned char *pucBuffer,
		   unsigned int uiCmd, unsigned char ucIsFast,
		   unsigned char ucIOWidth,
		   unsigned char ucDummyCount)  { unsigned int ui, uiCount, i;
	unsigned char *puc = pucBuffer;
	LDEBUG
	    ("ComSrlCmd_ComWrite: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; uiCmd=%x; uiIsfast=%x; ucIOWidth=%x; ucDummyCount=%x\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, uiCmd, ucIsFast,
	     ucIOWidth, ucDummyCount);
	SeqCmd_Order(ucChip, IOWIDTH_SINGLE, SPICMD_WREN);
	 ComSrlCmd_InputCommand(ucChip, uiAddr, uiCmd, ucIsFast, ucIOWidth,
...
// write a whole sector once
    unsigned int
ComSrlCmd_ComWriteSector(unsigned char ucChip, unsigned int uiAddr,
			 unsigned char *pucBuffer)  { unsigned int i, ui;
	unsigned char *puc = pucBuffer;
	unsigned int percent;
	LDEBUG
	    ("ComSrlCmd_ComWriteSector: ucChip=%x; uiAddr=%x; pucBuffer=%x; returnValue=%x;\n",
	     ucChip, uiAddr, (unsigned int)pucBuffer,
	     spi_flash_info[ucChip].sector_size);

	/* Display progress percentage */
	flash_progress_current++;
	if (flash_progress_total > 0) {
		percent = (flash_progress_current * 100) / flash_progress_total;
		if (percent != flash_progress_last_percent) {
			NDEBUG("\rProgress: %3d%%", percent);
			flash_progress_last_percent = percent;
		}
	}
	...
	for (i = 0; i < spi_flash_info[ucChip].page_cnt; i++)
		 {
		ui =
		    spi_flash_info[ucChip].pfPageWrite(ucChip, uiAddr,
						       spi_flash_info[ucChip].
						       page_size, puc);
...
// write sector use malloc buffer
    unsigned int
ComSrlCmd_BufWriteSector(unsigned char ucChip, unsigned int uiAddr,
			 unsigned int uiLen,
			 unsigned char *pucBuffer)  { unsigned char
	    pucSector[spi_flash_info[ucChip].sector_size];
	unsigned int ui, uiStartAddr, uiOffset;
	LDEBUG
	    ("ComSrlCmd_BufWriteSector:ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x;\n",
	...
	uiStartAddr = uiAddr - uiOffset;
	    ...
	    // get
	    ui =
	    spi_flash_info[ucChip].pfRead(ucChip, uiStartAddr,
					  spi_flash_info[ucChip].sector_size,
					  pucSector);
...
// write data, any address any lenth
    unsigned int
ComSrlCmd_ComWriteData(unsigned char ucChip, unsigned int uiAddr,
		       unsigned int uiLen,
		       unsigned char *pucBuffer)  { unsigned int uiStartAddr,
	    uiStartLen, uiSectorAddr, uiSectorCount, uiEndAddr, uiEndLen, i;
	unsigned char *puc = pucBuffer;
	LDEBUG
	    ("ComSrlCmd_ComWriteData:ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer);
	calAddr(uiAddr, uiLen, spi_flash_info[ucChip].sector_size,
		 &uiStartAddr, &uiStartLen, &uiSectorAddr, &uiSectorCount,
		 &uiEndAddr, &uiEndLen);

	/* Initialize progress tracking */
	flash_progress_current = 0;
	flash_progress_total = uiSectorCount + (uiStartLen > 0 ? 1 : 0) + (uiEndLen > 0 ? 1 : 0);
	flash_progress_last_percent = 0xff;
	NDEBUG("Writing %d bytes (%d sectors)\n", uiLen, flash_progress_total);
	...
	NDEBUG("\r                              \r");  /* Clear progress line */
...
// Set quad enable bit
    unsigned int
mxic_spi_setQEBit(unsigned char ucChip)  { unsigned int ui;
	SeqCmd_Order(ucChip, IOWIDTH_SINGLE, SPICMD_WREN);
	...
	KDEBUG("MxicSetQEBit: ucChip=%d; statusRegister=%x; returnValue=%x\n",
		ucChip, SeqCmd_Read(ucChip, IOWIDTH_SINGLE, SPICMD_RDSR, 1),
		ui);
	return ui;
}
...
// MX25L1605 MX25L3205 Read at High Speed (FAST_READ) Sequence (Command 0B)
    unsigned int
mxic_cmd_read_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		 unsigned char *pucBuffer)  {
	    KDEBUG
	    ("mxic_cmd_read_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_FASTREAD=%x;\n",
...
// MX25L1605 MX25L3205 Read at Dual IO Mode Sequence (Command BB)
    unsigned int
mxic_cmd_read_d1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		 unsigned char *pucBuffer)  {
	    KDEBUG
	    ("mxic_cmd_read_d1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_2READ=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_2READ);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_2READ, ISFAST_YES, IOWIDTH_DUAL,
				  DUMMYCOUNT_1);
}
...
// MX25L1635 MX25L3235 4 x I/O Read Mode Sequence (Command EB)
    unsigned int
mxic_cmd_read_q1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		 unsigned char *pucBuffer)  {
	    KDEBUG
	    ("mxic_cmd_read_q1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_4READ=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_4READ);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_4READ, ISFAST_YES, IOWIDTH_QUAD,
				  DUMMYCOUNT_3);
}
...
// Page Program (PP) Sequence (Command 02)
    unsigned int
mxic_cmd_write_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		  unsigned char *pucBuffer)  {
	    KDEBUG
	    ("mxic_cmd_write_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_PP=%x;\n",
...
// 4 x I/O Page Program (4PP) Sequence (Command 38)
    unsigned int
mxic_cmd_write_q1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		  unsigned char *pucBuffer)  {
	    KDEBUG
	    ("mxic_cmd_write_q1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_4PP=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_4PP);
	return ComSrlCmd_ComWrite(ucChip, uiAddr, uiLen, pucBuffer, SPICMD_4PP,
				   ISFAST_YES, IOWIDTH_QUAD, DUMMYCOUNT_0);
}
...
// Layer1 SST Byte-Program
    void
SstComSrlCmd_BP(unsigned char ucChip, unsigned int uiAddr,
		unsigned char ucValue)  { unsigned int ui;
	...
	SFCSR_CS_H(ucChip, 0, IOWIDTH_SINGLE);
	LDEBUG
	    ("SstComSrlCmd_BP: ucChip=%x; uiAddr=%x; ucValue=%x; SPICMD_SST_BP=%x;\n",
	     ucChip, uiAddr, ucValue, SPICMD_SST_BP);
} 
// Read at High Speed (FAST_READ) Sequence (Command 0B)
    unsigned int
sst_cmd_read_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		unsigned char *pucBuffer)  {
	    KDEBUG
	    ("sst_cmd_read_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_FASTREAD=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_FASTREAD);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_FASTREAD, ISFAST_YES, IOWIDTH_SINGLE,
				  DUMMYCOUNT_1);
...
// Layer2 Sector Write Use BP Mode
    unsigned int
sst_cmd_write_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		 unsigned char *pucBuffer)  { unsigned int i, ui;
	unsigned char *puc = pucBuffer;
	KDEBUG
	    ("sst_cmd_write_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; returnValue=%x;\n",
...
// Layer2 Spansion Set QE bit
    unsigned int
span_spi_setQEBit(unsigned char ucChip)  { unsigned int ui;
	SeqCmd_Order(ucChip, IOWIDTH_SINGLE, SPICMD_WREN);
	...
	KDEBUG("SpanSetQEBit: ucChip=%d; statusRegister=%x; returnValue=%x\n",
		ucChip, SeqCmd_Read(ucChip, IOWIDTH_SINGLE, SPICMD_SPAN_RCR, 2),
		ui);
	return spiFlashReady(ucChip);
}
...
// S25FL016A Layer1 Spansion FASTREAD Read Mode (Single IO)
    unsigned int
span_cmd_read_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		 unsigned char *pucBuffer)  {
	    KDEBUG
	    ("span_cmd_read_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_SPAN_FASTREAD=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer,
	     SPICMD_SPAN_FASTREAD);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_SPAN_FASTREAD, ISFAST_YES,
				  IOWIDTH_SINGLE, DUMMYCOUNT_1);
}


// S25FL032A Layer1 Spansion Quad Output Read Mode (QOR) 
    unsigned int
span_cmd_read_q0(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		 unsigned char *pucBuffer)  {
	    KDEBUG
	    ("span_cmd_read_q0: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_SPAN_QOR=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_SPAN_QOR);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_SPAN_QOR, ISFAST_NO, IOWIDTH_QUAD,
				  DUMMYCOUNT_1);
}
...
// Layer1 Spansion Single IO Program (PP)
    unsigned int
span_cmd_write_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		  unsigned char *pucBuffer)  {
	    KDEBUG
	    ("span_cmd_write_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_SPAN_PP=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_SPAN_PP);
	return ComSrlCmd_ComWrite(ucChip, uiAddr, uiLen, pucBuffer,
				   SPICMD_SPAN_PP, ISFAST_YES, IOWIDTH_SINGLE,
				   DUMMYCOUNT_0);
}
...
// Layer1 Spansion QUAD Page Program (QPP)
    unsigned int
span_cmd_write_q0(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		  unsigned char *pucBuffer)  {
	    KDEBUG
	    ("span_cmd_write_q0: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_SPAN_QPP=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_SPAN_QPP);
	return ComSrlCmd_ComWrite(ucChip, uiAddr, uiLen, pucBuffer,
				   SPICMD_SPAN_QPP, ISFAST_NO, IOWIDTH_QUAD,
				   DUMMYCOUNT_0);
}
...
// Layer3 Winbond Set QE Bit
    unsigned int
wb_spi_setQEBit(unsigned char ucChip)  { 
	...
	KDEBUG("WBSetQEBit: ucChip=%d; statusRegister=%x; returnValue=%x\n",
		ucChip, SeqCmd_Read(ucChip, IOWIDTH_SINGLE, SPICMD_WB_RDSR, 1),
		ui);
	return spiFlashReady(ucChip);
}
...
// W25Q80 W25Q16 W25Q32 4 x I/O Read Mode Sequence (Command EB)
    unsigned int
wb_cmd_read_q0(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
	       unsigned char *pucBuffer)  {
	    KDEBUG
	    ("wb_cmd_read_q1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_WB_4READ=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_WB_4READ);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_WB_4READ, ISFAST_NO, IOWIDTH_QUAD,
				  DUMMYCOUNT_1);
}
...
// 4 x I/O Page Program (4PP) Sequence (Command 38)
    unsigned int
wb_cmd_write_q0(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		unsigned char *pucBuffer)  {
	    KDEBUG
	    ("wb_cmd_write_q1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_WB_QPP=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_WB_QPP);
	return ComSrlCmd_ComWrite(ucChip, uiAddr, uiLen, pucBuffer,
				   SPICMD_WB_QPP, ISFAST_NO, IOWIDTH_QUAD,
				   DUMMYCOUNT_0);
}
...
// Eon read Single IO
    unsigned int
eon_cmd_read_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		unsigned char *pucBuffer)  {
	    KDEBUG
	    ("eon_cmd_read_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_EON_FASTREAD=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer,
	     SPICMD_EON_FASTREAD);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_EON_FASTREAD, ISFAST_YES,
				  IOWIDTH_SINGLE, DUMMYCOUNT_1);
}
...
// Eon Read Quad IO
    unsigned int
eon_cmd_read_q1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		unsigned char *pucBuffer)  {
	    KDEBUG
	    ("eon_cmd_read_q1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_EON_4FASTREAD=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer,
	     SPICMD_EON_4FASTREAD);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_EON_4FASTREAD, ISFAST_YES,
				  IOWIDTH_QUAD, DUMMYCOUNT_3);
}


// Page Program (PP) Sequence (Command 02)
    unsigned int
eon_cmd_write_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		 unsigned char *pucBuffer)  {
	    KDEBUG
	    ("eon_cmd_write_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_EON_PP=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_EON_PP);
	return ComSrlCmd_ComWrite(ucChip, uiAddr, uiLen, pucBuffer,
				   SPICMD_EON_PP, ISFAST_NO, IOWIDTH_SINGLE,
				   DUMMYCOUNT_0);
}
...
// Set quad enable bit
    unsigned int
gd_spi_setQEBit(unsigned char ucChip)  { unsigned int ui;
	SeqCmd_Order(ucChip, IOWIDTH_SINGLE, SPICMD_WREN);
	...
	KDEBUG
	    ("gd_spi_setQEBit: ucChip=%d; statusRegister=%x; returnValue=%x\n",
...
// GD25Q16 Read at Fast read Quad Sequence (Command EB)
    unsigned int
gd_cmd_read_q0(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
	       unsigned char *pucBuffer)  {
	    KDEBUG
	    ("gd_cmd_read_q0: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_GD_READ4=%x;\n",
	...
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				 SPICMD_GD_READ4, ISFAST_NO, IOWIDTH_QUAD,
				 DUMMYCOUNT_1);
}
...
// Page Program (PP) Sequence (Command 02)
    unsigned int
gd_cmd_write_s1(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		unsigned char *pucBuffer)  {
	    KDEBUG
	    ("gd_cmd_write_s1: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_GD_PP=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_PP);
	return ComSrlCmd_ComWrite(ucChip, uiAddr, uiLen, pucBuffer,
				   SPICMD_GD_PP, ISFAST_NO, IOWIDTH_SINGLE,
				   DUMMYCOUNT_0);
}
...
// AT25DF161 Dual-Output Read Array(Command 3B)
    unsigned int
at_cmd_read_d0(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
	       unsigned char *pucBuffer)  {
	    KDEBUG
	    ("at_cmd_read_d0: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_AT_READ2=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_AT_READ2);
	return ComSrlCmd_ComRead(ucChip, uiAddr, uiLen, pucBuffer,
				  SPICMD_AT_READ2, ISFAST_NO, IOWIDTH_DUAL,
				  DUMMYCOUNT_1);
}
...
// AT25DF161 Dual-Input Byte/Page Program(Command A2)
    unsigned int
at_cmd_write_d0(unsigned char ucChip, unsigned int uiAddr, unsigned int uiLen,
		unsigned char *pucBuffer)  {
	    KDEBUG
	    ("at_cmd_write_s0: ucChip=%x; uiAddr=%x; uiLen=%x; pucBuffer=%x; SPICMD_AT_PP2=%x;\n",
	     ucChip, uiAddr, uiLen, (unsigned int)pucBuffer, SPICMD_AT_PP2);
	return ComSrlCmd_ComWrite(ucChip, uiAddr, uiLen, pucBuffer,
				   SPICMD_AT_PP2, ISFAST_NO, IOWIDTH_DUAL,
				   DUMMYCOUNT_0);
}
