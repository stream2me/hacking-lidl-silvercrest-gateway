...
/* Standard library function declarations to avoid implicit declaration warnings */
extern void *memcpy(void *dest, const void *src, uint32 n);
extern void *memset(void *s, int c, uint32 n);
extern void *memmove(void *dest, const void *src, uint32 n);
extern int memcmp(const void *s1, const void *s2, uint32 n);
extern void bzero(void *s, uint32 n);
