...
/* PCIE definitions (formerly from test_hw_96d.h) */
#ifndef PCIE0_RC_CFG_BASE
#define PCIE0_RC_CFG_BASE       0xb8b00000
#endif
#ifndef PCIE0_EP_CFG_BASE
#define PCIE0_EP_CFG_BASE       0xb8b10000
#endif
#ifndef PCIE0_MAP_IO_BASE
#define PCIE0_MAP_IO_BASE       0xb8c00000
#endif
#ifndef PCIE0_MAP_MEM_BASE
#define PCIE0_MAP_MEM_BASE      0xb9000000
#endif
#ifndef PCIE1_RC_CFG_BASE
#define PCIE1_RC_CFG_BASE       0xb8b20000
#endif
#ifndef PCIE1_EP_CFG_BASE
#define PCIE1_EP_CFG_BASE       0xb8b30000
#endif
#ifndef PCIE1_MAP_IO_BASE
#define PCIE1_MAP_IO_BASE       0xb8e00000
#endif
#ifndef PCIE1_MAP_MEM_BASE
#define PCIE1_MAP_MEM_BASE      0xba000000
#endif
#ifndef PCIE0_MDIO
#define PCIE0_MDIO              0xb8b000c0
#endif
#ifndef PCIE1_MDIO
#define PCIE1_MDIO              0xb8b200c0
#endif
#ifndef PCIE_MDIO_REG_OFFSET
#define PCIE_MDIO_REG_OFFSET    8
#endif
#ifndef PCIE_MDIO_DATA_OFFSET
#define PCIE_MDIO_DATA_OFFSET   16
#endif
#ifndef PCIE_MDIO_RDWR_OFFSET
#define PCIE_MDIO_RDWR_OFFSET   0
#endif

/* Debug print macro (formerly from test_lib.h) */
#ifndef DBG_PRINT
...
void
PCIE_MDIO_Reset(unsigned int portnum)
{
#ifndef SYS_PCIE_PHY0
#define SYS_PCIE_PHY0   (0xb8000000 +0x50)
#endif
#ifndef SYS_PCIE_PHY1
...
//------------------------------------------------------------------------
void
PCIE_PHY_Reset(unsigned int portnum)
{
...
//------------------------------------------------------------------------
int
PCIE_Check_Link(unsigned int portnum)
{
	...
	{
		if (portnum == 0)
			REG32(PCIE0_RC_CFG_BASE + 0x04) = 0x00100007;
		else if (portnum == 1)
			REG32(PCIE1_RC_CFG_BASE + 0x04) = 0x00100007;
...
void
HostPCIe_SetPhyMdioWrite(unsigned int portnum, unsigned int regaddr,
			 unsigned short val)
{
	...
	if (portnum == 0)
		...
		mdioaddr = 0xb8b410c0;	//EP MDIO     
	else
		return;

	REG32(mdioaddr) =
	    ((regaddr & 0x1f) << PCIE_MDIO_REG_OFFSET) | ((val & 0xffff) <<
							  PCIE_MDIO_DATA_OFFSET)
...
void
PCIE_reset_procedure(int portnum, int Use_External_PCIE_CLK, int mdio_reset)
{
...
#define CLK_MANAGE 	0xb8000010
	...
	if (portnum == 1)
		REG32(0xb8b2100c) = (2 << 3);	//set target Device Num=1;
...
//--------------------------------------------------------------------------
int
PCIE_Host_Init(int argc, char *argv[])
{
	int portnum = 0;
	if (argc >= 1) {
...
int
rtl8196e_get_gpio_sw_in(void)
{
	if ((REG32(BOND_OPTION) & BOND_ID_MASK) == BOND_8196ES) {
		return (!
			((*(volatile u32 *)(gpio_pin_ctrl_reg + 0x44)) &
			 (1 << 0)));
	} else {
...
rtl8196e_gpio_init(void)
{
	...
	if ((REG32(BOND_OPTION) & BOND_ID_MASK) == BOND_8196ES) {
		...
		gpio_pin_ctrl_reg =
		    (REG32(PCIE0_EP_CFG_BASE + 0x18) & 0xffff0000) | 0xb0000000;
