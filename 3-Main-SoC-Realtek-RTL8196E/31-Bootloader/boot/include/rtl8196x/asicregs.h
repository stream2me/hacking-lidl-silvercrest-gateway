...
/*
 * RTL865XC Platform (refer to rtl865xc_asicregs.h of 865x driver of linux)
 */
...
#define table_access_addr_base(type)                                           \
	(SWTABLE_BASE_OF_ALL_TABLES + 0x10000 * (type))
...
#define CAP_100BASE_MASK                                                       \
	(0x1F << CAP_100BASE_OFFSET) /* 10/100 capability mask */
...
#define ADVCAP_1000BASE_MASK                                                   \
	(0x3 << ADVCAP_1000BASE_OFFSET) /* advertisement capability mask */
#define LPCAP_1000BASE_MASK                                                    \
	(0x3 << LPCAP_1000BASE_OFFSET) /* link partner status mask */
...
#define CPURPDCR5 (0x018 + CPU_IFACE_BASE) /* Rx pkthdr descriptor control 5   \
					    */
#define CPURPDCR(idx)                                                          \
	(CPURPDCR0 + (idx << 2)) /* Rx pkthdr descriptor control with index */

#define CPURMDCR0 (0x01c + CPU_IFACE_BASE) /* Rx mbuf descriptor control */
#define CPUTPDCR0                                                              \
	(0x020 + CPU_IFACE_BASE) /* Tx pkthdr descriptor control Low */
#define CPUTPDCR1                                                              \
	(0x024 + CPU_IFACE_BASE) /* Tx pkthdr descriptor control High */
#define CPUTPDCR(idx)                                                          \
	(CPUTPDCR0 + (idx << 2)) /* Tx pkthdr descriptor control with index */

#define CPUTPDCR2                                                              \
	(0x060 + CPU_IFACE_BASE) /* Tx Pkthdr Descriptor 2 Control Register */
#define CPUTPDCR3                                                              \
	(0x064 + CPU_IFACE_BASE) /* Tx Pkthdr Descriptor 3 Control Register */

#define CPUIIMR (0x028 + CPU_IFACE_BASE) /* Interrupt mask control */
#define CPUIISR (0x02c + CPU_IFACE_BASE) /* Interrupt status control */
#define CPUQDM0                                                                \
	(0x030 +                                                               \
	 CPU_IFACE_BASE) /* Queue ID 0 and Descriptor Ring Mapping Register */
#define CPUQDM1                                                                \
	(0x032 +                                                               \
	 CPU_IFACE_BASE) /* Queue ID 1 and Descriptor Ring Mapping Register */
#define CPUQDM2                                                                \
	(0x034 +                                                               \
	 CPU_IFACE_BASE) /* Queue ID 2 and Descriptor Ring Mapping Register */
#define CPUQDM3                                                                \
	(0x036 +                                                               \
	 CPU_IFACE_BASE) /* Queue ID 3 and Descriptor Ring Mapping Register */
#define CPUQDM4                                                                \
	(0x038 +                                                               \
	 CPU_IFACE_BASE) /* Queue ID 4 and Descriptor Ring Mapping Register */
#define CPUQDM5                                                                \
	(0x03a +                                                               \
	 CPU_IFACE_BASE) /* Queue ID 5 and Descriptor Ring Mapping Register */
...
#define RX_ERR_IE_ALL                                                          \
	(0x3f << 25) /* Rx error interrupt enable for any descriptor */
...
#define TX_ERR_IE_ALL                                                          \
	(0x3 << 23)	    /* Tx error interrupt pending for any descriptor */
#define TX_ERR_IE (1 << 29) /* Tx error interrupt enable */

#define PKTHDR_DESC_RUNOUT_IE0                                                 \
	(1 << 17) /* Run out pkthdr descriptor 0 interrupt enable */
#define PKTHDR_DESC_RUNOUT_IE1                                                 \
	(1 << 18) /* Run out pkthdr descriptor 1 interrupt enable */
#define PKTHDR_DESC_RUNOUT_IE2                                                 \
	(1 << 19) /* Run out pkthdr descriptor 2 interrupt enable */
#define PKTHDR_DESC_RUNOUT_IE3                                                 \
	(1 << 20) /* Run out pkthdr descriptor 3 interrupt enable */
#define PKTHDR_DESC_RUNOUT_IE4                                                 \
	(1 << 21) /* Run out pkthdr descriptor 4 interrupt enable */
#define PKTHDR_DESC_RUNOUT_IE5                                                 \
	(1 << 22) /* Run out pkthdr descriptor 5 interrupt enable */
#define PKTHDR_DESC_RUNOUT_IE_ALL                                              \
	(0x3f << 17) /* Run out anyone pkthdr descriptor interrupt pending */

#define MBUF_DESC_RUNOUT_IE0                                                   \
	(1 << 11) /* Run out mbuf descriptor 0 interrupt enable */

#define TX_DONE_IE0                                                            \
	(1 << 9) /* Tx Descript Ring 0 one packet done interrupt enable */
#define TX_DONE_IE1                                                            \
	(1 << 10) /* Tx Descript Ring 1 one packet done interrupt enable */
#define TX_DONE_IE_ALL                                                         \
	(0x3 << 9) /* Any Tx Descript Ring one packet done interrupt enable */

#define RX_DONE_IE0                                                            \
	(1 << 3) /* Rx Descript Ring 0 one packet done interrupt enable */
#define RX_DONE_IE1                                                            \
	(1 << 4) /* Rx Descript Ring 1 one packet done interrupt enable */
#define RX_DONE_IE2                                                            \
	(1 << 5) /* Rx Descript Ring 2 one packet done interrupt enable */
#define RX_DONE_IE3                                                            \
	(1 << 6) /* Rx Descript Ring 3 one packet done interrupt enable */
#define RX_DONE_IE4                                                            \
	(1 << 7) /* Rx Descript Ring 4 one packet done interrupt enable */
#define RX_DONE_IE5                                                            \
	(1 << 8) /* Rx Descript Ring 5 one packet done interrupt enable */
#define RX_DONE_IE_ALL                                                         \
	(0x3f << 3) /* Rx Descript Ring any one packet done interrupt enable   \
		     */

#define TX_ALL_DONE_IE0                                                        \
	(1 << 1) /* Tx Descript Ring 0 all packets done interrupt enable */
#define TX_ALL_DONE_IE1                                                        \
	(1 << 2) /* Tx Descript Ring 1 all packets done interrupt enable */
#define TX_ALL_DONE_IE_ALL                                                     \
	(0x3 << 1) /* Any Tx Descript Ring all packets done interrupt enable   \
		    */
...
#define RX_ERR_IP_ALL                                                          \
	(0x3f << 25) /* Rx error any descriptor interrupt pending */
#define RX_ERR_IP(idx)                                                         \
	(1 << (25 + (idx))) /* Rx error descriptor [IDX] interrupt pending */
...
#define TX_ERR_IP_ALL                                                          \
	(0x3 << 23) /* Tx error any descriptor interrupt pending */
#define TX_ERR_IP(idx)                                                         \
	(1 << (23 + (idx))) /* Tx error descriptor [IDX] interrupt pending */

#define PKTHDR_DESC_RUNOUT_IP0                                                 \
	(1 << 17) /* Run out pkthdr descriptor 0 interrupt pending */
#define PKTHDR_DESC_RUNOUT_IP1                                                 \
	(1 << 18) /* Run out pkthdr descriptor 1 interrupt pending */
#define PKTHDR_DESC_RUNOUT_IP2                                                 \
	(1 << 19) /* Run out pkthdr descriptor 2 interrupt pending */
#define PKTHDR_DESC_RUNOUT_IP3                                                 \
	(1 << 20) /* Run out pkthdr descriptor 3 interrupt pending */
#define PKTHDR_DESC_RUNOUT_IP4                                                 \
	(1 << 21) /* Run out pkthdr descriptor 4 interrupt pending */
#define PKTHDR_DESC_RUNOUT_IP5                                                 \
	(1 << 22) /* Run out pkthdr descriptor 5 interrupt pending */
#define PKTHDR_DESC_RUNOUT_IP_ALL                                              \
	(0x3f << 17) /* Run out anyone pkthdr descriptor interrupt pending */
#define PKTHDR_DESC_RUNOUT_IP(idx)                                             \
	(1 << (17 +                                                            \
	       (idx))) /* Run out pkthdr descriptor [IDX] interrupt pending */

#define MBUF_DESC_RUNOUT_IP0                                                   \
	(1 << 16) /* Run out mbuf descriptor 0 interrupt pending */

#define TX_DONE_IP0                                                            \
	(1 << 9) /* Tx one packet done interrupt for descriptor 0 pending */
#define TX_DONE_IP1                                                            \
	(1 << 10) /* Tx one packet done interrupt for descriptor 1 pending */
#define TX_DONE_IP_ALL                                                         \
	(0x3 << 9) /* Tx one packet done interrupt for any descriptor pending  \
		    */
#define TX_DONE_IP(idx)                                                        \
	(1 << (9 + (idx))) /* Tx one packet done interrupt for descriptor      \
			      [IDX] pending */
...
#define RX_DONE_IP_ALL                                                         \
	(0x3f << 3) /* Rx one packet done anyone interrupt pending */
#define RX_DONE_IP(idx)                                                        \
	(1 << (3 + (idx))) /* Rx one packet done [IDX] interrupt pending */
...
#define TX_ALL_DONE_IP_ALL                                                     \
	(0x03 << 1) /* Tx all packets done any interrupt pending */
#define TX_ALL_DONE_IP(idx)                                                    \
	(1 << (1 + (idx))) /* Tx all packets done interrupt [IDX] pending */

#define INTPENDING_NIC_MASK                                                    \
	(RX_ERR_IP_ALL | TX_ERR_IP_ALL | RX_DONE_IP_ALL |                      \
	 PKTHDR_DESC_RUNOUT_IP_ALL)
#define INTPENDING_RUN_OUT (PKTHDR_DESC_RUNOUT_IP_ALL)

/* CPUQDM0,CPUQDM1,CPUQDM2,CPUQDM3,CPUQDM4,CPUQDM5 - Queue ID 0~5 and Descriptor
 * Ring Mapping Register */
...
#define GCSR1 (DESCDIAG_BASE + 0x00c) /* Global Congestion Status Register 1   \
				       */
#define P0_DCR0                                                                \
	(DESCDIAG_BASE + 0x010) /* Port 0 Descriptor Counter Register 0 */
#define P0_DCR1                                                                \
	(DESCDIAG_BASE + 0x014) /* Port 0 Descriptor Counter Register 1 */
#define P0_DCR2                                                                \
	(DESCDIAG_BASE + 0x018) /* Port 0 Descriptor Counter Register 2 */
#define P0_DCR3                                                                \
	(DESCDIAG_BASE + 0x01c) /* Port 0 Descriptor Counter Register 3 */
#define P1_DCR0                                                                \
	(DESCDIAG_BASE + 0x020) /* Port 1 Descriptor Counter Register 0 */
#define P1_DCR1                                                                \
	(DESCDIAG_BASE + 0x024) /* Port 1 Descriptor Counter Register 1 */
#define P1_DCR2                                                                \
	(DESCDIAG_BASE + 0x028) /* Port 1 Descriptor Counter Register 2 */
#define P1_DCR3                                                                \
	(DESCDIAG_BASE + 0x02c) /* Port 1 Descriptor Counter Register 3 */
#define P2_DCR0                                                                \
	(DESCDIAG_BASE + 0x030) /* Port 2 Descriptor Counter Register 0 */
#define P2_DCR1                                                                \
	(DESCDIAG_BASE + 0x034) /* Port 2 Descriptor Counter Register 1 */
#define P2_DCR2                                                                \
	(DESCDIAG_BASE + 0x038) /* Port 2 Descriptor Counter Register 2 */
#define P2_DCR3                                                                \
	(DESCDIAG_BASE + 0x03c) /* Port 2 Descriptor Counter Register 3 */
#define P3_DCR0                                                                \
	(DESCDIAG_BASE + 0x040) /* Port 3 Descriptor Counter Register 0 */
#define P3_DCR1                                                                \
	(DESCDIAG_BASE + 0x044) /* Port 3 Descriptor Counter Register 1 */
#define P3_DCR2                                                                \
	(DESCDIAG_BASE + 0x048) /* Port 3 Descriptor Counter Register 2 */
#define P3_DCR3                                                                \
	(DESCDIAG_BASE + 0x04c) /* Port 3 Descriptor Counter Register 3 */
#define P4_DCR0                                                                \
	(DESCDIAG_BASE + 0x050) /* Port 4 Descriptor Counter Register 0 */
#define P4_DCR1                                                                \
	(DESCDIAG_BASE + 0x054) /* Port 4 Descriptor Counter Register 1 */
#define P4_DCR2                                                                \
	(DESCDIAG_BASE + 0x058) /* Port 4 Descriptor Counter Register 2 */
#define P4_DCR3                                                                \
	(DESCDIAG_BASE + 0x05c) /* Port 4 Descriptor Counter Register 3 */
#define P5_DCR0                                                                \
	(DESCDIAG_BASE + 0x060) /* Port 5 Descriptor Counter Register 0 */
#define P5_DCR1                                                                \
	(DESCDIAG_BASE + 0x064) /* Port 5 Descriptor Counter Register 1 */
#define P5_DCR2                                                                \
	(DESCDIAG_BASE + 0x068) /* Port 5 Descriptor Counter Register 2 */
#define P5_DCR3                                                                \
	(DESCDIAG_BASE + 0x06c) /* Port 5 Descriptor Counter Register 3 */
#define P6_DCR0                                                                \
	(DESCDIAG_BASE + 0x070) /* Port CPU Descriptor Counter Register 0 */
#define P6_DCR1                                                                \
	(DESCDIAG_BASE + 0x074) /* Port CPU Descriptor Counter Register 1 */
#define P6_DCR2                                                                \
	(DESCDIAG_BASE + 0x078) /* Port CPU Descriptor Counter Register 2 */
#define P6_DCR3                                                                \
	(DESCDIAG_BASE + 0x07c) /* Port CPU Descriptor Counter Register 3 */

/* GDSR0 - Global Descriptor Status Register 0 */
#define DSCRUNOUT (1 << 27) /* Descriptor Run Out */
#define TotalDscFctrl_Flag                                                     \
	(1 << 26)		   /* TotalDescriptor Flow Control event flag */
#define USEDDSC_OFFSET 16	   /* Total Used Descriptor */
#define USEDDSC_MASK (0x3ff << 16) /* Total Used Descriptor */
#define SharedBufFCON_Flag                                                     \
	(1 << 14)	    /* SharedBufFCON threshold triggerred flag */
...
#define MIITM_TXR0                                                             \
	(0x400 + SWCORECNR) /* MAC Test Mode MII TX Interface Register */
#define MIITM_TXR1                                                             \
	(0x404 + SWCORECNR) /* MAC Test Mode MII TX Interface Register */
#define MIITM_RXR0                                                             \
	(0x408 + SWCORECNR) /* MAC Test Mode MII RX Interface Register */
#define MIITM_RXR1                                                             \
	(0x40C + SWCORECNR) /* MAC Test Mode MII RX Interface Register */
#define GMIITM_TXR0                                                            \
	(0x400 + SWCORECNR) /* MAC Test Mode MII TX Interface Register */
#define GMIITM_TXR1                                                            \
	(0x404 + SWCORECNR) /* MAC Test Mode MII TX Interface Register */
...
#define MII_ENFORCE_MODE                                                       \
	(1 << 4) /* Enable MII port property set by force mode */
/* Qos by DS control register
 */
/* Qos control register
 */
#define QWEIGHT_MASK (3 << 30)
#define QWEIGHT_ALWAYS_H                                                       \
	(3 << 30) /* Weighted round robin of priority always high first */
#define QWEIGHT_16TO1                                                          \
	(2 << 30)	      /* Weighted round robin of priority queue 16:1 */
...
/*#define P4_USB_SEL                          (1 << 25)    Select port USB
 * interface */
#define EN_P5_LINK_PHY                                                         \
	(1 << 26) /* Enable port 5 PHY provides link status to MAC */
#define EN_P4_LINK_PHY                                                         \
	(1 << 25) /* Enable port 4 PHY provides link status to MAC */
#define EN_P3_LINK_PHY                                                         \
	(1 << 24) /* Enable port 3 PHY provides link status to MAC */
#define EN_P2_LINK_PHY                                                         \
	(1 << 23) /* Enable port 2 PHY provides link status to MAC */
#define EN_P1_LINK_PHY                                                         \
	(1 << 22) /* Enable port 1 PHY provides link status to MAC */
#define EN_P0_LINK_PHY                                                         \
	(1 << 21) /* Enable port 0 PHY provides link status to MAC */

/*When enabled, the authorized node are allowed in one direction ("IN"
direction) to forward packet to the unauthorized node. Otherwise, it is not
allowed. 0= BOTH direction. (control for the packets that "SA=" or "DA=" this
MAC address.) 1= IN direction. (control for the packets that "SA=" this MAC
address.)	*/
...
#define BACKOFF_EXPONENTIAL_3                                                  \
	(1 << 27)		   /* Set back off exponential parameter 9 */
...
#define CF_FCDSC_OFFSET                                                        \
	(4) /* Flow control DSC tolerance, default: 24 pages ( also minimum    \
	       value ) */
#define CF_FCDSC_MASK                                                          \
	(0x7f << 4) /* Flow control DSC tolerance, default: 24 pages ( also    \
		       minimum value ) */
#define CF_RXIPG_MASK                                                          \
	(0xf << 0) /* Min. IPG limitation for RX receiving packetMinimum value \
		      is 6. Maximum value is 12. */
...
#define MirrorPortMsk_OFFSET                                                   \
	18 /* Port receiving the mirrored traffic (single bit set to 1 is      \
	      allowed) */
#define MirrorPortMsk_MASK                                                     \
	(0x1ff << 18) /* Port receiving the mirrored traffic (single bit set   \
			 to 1 is allowed) */
#define MirrorRxPrtMsk_OFFSET                                                  \
	9 /* Rx port to be mirrored (Source Mirroring, multiple ports allowed) \
	   */
#define MirrorRxPrtMsk_MASK                                                    \
	(0x1ff << 9) /* Rx port to be mirrored (Source Mirroring, multiple     \
			ports allowed) */
#define MirrorTxPrtMsk_OFFSET                                                  \
	0 /* Tx port to be mirrored (Destination Mirroring, multiple ports     \
	     allowed) */
#define MirrorTxPrtMsk_MASK                                                    \
	(0x1ff << 0) /* Tx port to be mirrored (Destination Mirroring,         \
...
#define MatchOpRx5_MTMP                                                        \
	(3 << 24)	     /* Mirror to Mirror Port if matched on port 5 */
...
#define MatchOpRx4_MTMP                                                        \
	(3 << 22)	     /* Mirror to Mirror Port if matched on port 4 */
...
#define MatchOpRx3_MTMP                                                        \
	(3 << 20)	     /* Mirror to Mirror Port if matched on port 3 */
...
#define MatchOpRx2_MTMP                                                        \
	(3 << 18)	     /* Mirror to Mirror Port if matched on port 2 */
...
#define MatchOpRx1_MTMP                                                        \
	(3 << 16)	     /* Mirror to Mirror Port if matched on port 1 */
...
#define MatchOpRx0_MTMP                                                        \
	(3 << 14) /* Mirror to Mirror Port if matched on port 0 */
...
#define AcceptL2Err                                                            \
	(1 << 3) /* CPU port L2 CRC Error Allow; 0: Not Allowed, 1: Allowed    \
		    (default) */
...
#define Port_embPhyID_MASK(port)                                               \
	(0x1f << (port * 5)) /* Embedded PHY ID MASK of port 'idx' */
#define Port_embPhyID(id, port)                                                \
	(id << (port * 5)) /* Embedded PHY ID setting of port 'idx' */
...
#define PCRP6                                                                  \
	(0x01C + PCRAM_BASE) /* Port Configuration Register of Ext Port 0 */
#define PCRP7                                                                  \
	(0x020 + PCRAM_BASE) /* Port Configuration Register of Ext Port 1 */
#define PCRP8                                                                  \
	(0x024 + PCRAM_BASE) /* Port Configuration Register of Ext Port 2 */
...
/* PCRP0,PCRP1,PCRP2,PCRP3,PCRP4,PCRP5,PCRP6,PCRP7,PCRP8 - Port Configuration
 * Register */
...
#define EnForceMode                                                            \
	(1 << 25) /* Enable Force Mode to set link/speed/duplix/flow status */

/* 	EnForceMode=0,  PollLinkStatus: do not care
	EnForceMode=1, PollLinkStatus=0 : ForceMode , disable Auto-Negotiation.
   It's noted that The mode should be setting for MAC-to-MAC connection.
				    PollLinkStatus=1:  ForceMode with polling
   link status, disable Auto-Negotiation but polling phy's link status.
 */
#define PollLinkStatus (1 << 24)
#define ForceLink (1 << 23) /* 0-link down, 1-link up */

/*	FrcAbi_AnAbi_sel[4:0]: bit 22 ~ 18
	If EnForceMode = 1, FrcAbi_AnAbi_sel is used to indicate the force mode
   operation. (For either MAC mode or PHY mode operation.) FrcAbi_AnAbi_sel[0] =
   ForceDuplex1: force FULL duplex ,  0: force HALF duplex FrcAbi_AnAbi_sel[2:1]
   = ForceSpeed00: force 10Mbps   01: force 100Mbps  ( default setting for
   port#5 NFBI-PHY-mode spec. ) 10: force 1000Mbps 11: reserved.
	FrcAbi_AnAbi_sel[4:3] = Reserved, useless.
	If EnForceMode = 0, FrcAbi_AnAbi_sel is used to indicate
   Auto-Negotiation advertise ability. FrcAbi_AnAbi_sel[0]: 10Mbps
   Half-duplexFrcAbi_AnAbi_sel[1]: 10Mbps Full-duplexFrcAbi_AnAbi_sel[2]:
   100Mbps Half-duplex FrcAbi_AnAbi_sel[3]: 100Mbps
   Full-duplexFrcAbi_AnAbi_sel[4]: 1000Mbps Full-duplex
 */
/* 8196c or 8198 has no bit 20, 21 definition */
#define IPMSTP_PortST_MASK                                                     \
	(3 << 21) /* Mask of IP Multicast Spanning Tree Protocol Port State    \
		     Control */
#define IPMSTP_PortST_OFFSET                                                   \
	(21) /* Offset of IP Multicast Spanning Tree Protocol Port State       \
		Control */
#define IPMSTP_PortST_DISABLE                                                  \
	(0 << 21) /* Disable State of IP Multicast Spanning Tree Protocol Port \
		     State Control */
#define IPMSTP_PortST_BLOCKING                                                 \
	(1 << 21) /* Blocking State of IP Multicast Spanning Tree Protocol     \
		     Port State Control */
#define IPMSTP_PortST_LISTENING                                                \
	(1 << 21) /* Listening State of IP Multicast Spanning Tree Protocol    \
		     Port State Control */
#define IPMSTP_PortST_LEARNING                                                 \
	(2 << 21) /* Learning State of IP Multicast Spanning Tree Protocol     \
		     Port State Control */
#define IPMSTP_PortST_FORWARDING                                               \
	(3 << 21) /* Forwarding State of IP Multicast Spanning Tree Protocol   \
		     Port State Control */
 ...
 */
#define PauseFlowControl_MASK                                                  \
	(3 << 16) /* Mask for per-port 802.3 PAUSE flow control ability        \
		     control */
...
// #define BCSC_ENUNKNOWNUNICAST               (1<<11)     /* Enable control for
// unknown unicast packet */
#define BCSC_Types_MASK                                                        \
	(7 << 9) /* Broadcast Storm Control packet type selection */
...
#define DisBKP                                                                 \
	(1 << 6) /* Per-port Disable Backpressure function for Half duplex */
#define STP_PortST_MASK                                                        \
	(3 << 4) /* Mask Spanning Tree Protocol Port State Control */
...
#define AcptMaxLen_OFFSET                                                      \
	(1) /* Enable the max acceptable packet length supported */
#define AcptMaxLen_MASK                                                        \
	(3 << 1) /* Enable the max acceptable packet length supported */
...
#define AcptMaxLen_16K                                                         \
	(3 << 1)	     /* 16370 bytes = 16K-2(cutoff)-4(vlan)-8(pppoe) */
#define EnablePHYIf (1 << 0) /* Enable PHY interface. */

/* 0xBB804150 P5GMIICR */
#define Conf_done                                                              \
	(1 << 6) /*Port5 configuration is done to enable the frame reception   \
		    and transmission.	*/
#define P5txdely (1 << 4) /*Port5 TX clock delay.	*/

/* PSRP0,PSRP1,PSRP2,PSRP3,PSRP4,PSRP5,PSRP6,PSRP7,PSRP8 - Port Status Register
 * Port 0~8 */
#define LinkDownEventFlag                                                      \
	(1 << 8) /* Port Link Down Event detecting monitor flag */
...
#define CFG_GMAC_MASK                                                          \
	(3 << 23) /* The register default reflect the HW power on strapping    \
		     value of H/W pin. */
...
#define PLITIMR                                                                \
	(0x20 +                                                                \
	 ALE_BASE) /* Port to LAN Interface Table Index Mapping Register */
...
#define MGFCR_E0R0                                                             \
	(0x2C +                                                                \
	 ALE_BASE) /*L2 MAC Group Forwarding Control Register Entry_0 R0 */
#define MGFCR_E0R1                                                             \
	(0x30 +                                                                \
	 ALE_BASE) /*L2 MAC Group Forwarding Control Register Entry_1 R1 */
#define MGFCR_E0R2                                                             \
	(0x34 +                                                                \
	 ALE_BASE) /*L2 MAC Group Forwarding Control Register Entry_2 R2 */
#define MGFCR_E1R0                                                             \
	(0x38 +                                                                \
	 ALE_BASE) /*L2 MAC Group Forwarding Control Register Entry_0 R0 */
#define MGFCR_E1R1                                                             \
...
#define EnRateLimitTbAging                                                     \
	(1 << 6) /* Enable Rate Limit table hardware aging function. */
#define EnL2FastAging (1 << 5) /* Enable L2 Fast Aging Out */
#define EnL2HashColOW (1 << 4) /* Enable L2 Tablsh Hash Collision Over Write   \
				*/
#define IPMcastAgingDisable                                                    \
	(1 << 3) /* 0=Enable IP Multicast table aging. 1=disable */
...
#define MADDR0E                                                                \
	(1 << 3) /* IEEE Std. 802.1AB Link Layer Discovery protocol multicast  \
		    address */
...
/* ALECR */
#define EN_PPPOE                                                               \
	(1 << 18) /* Enable PPPoE auto-encapsulation and auto-decapsulation */
#define TTL_1Enable (1 << 16) /* Enable TTL-1 operation for L3 routing */
#define Fragment2CPU                                                           \
	(1 << 15) /* When ACL is enabled, enable all fragmented IP packet to   \
		     be trapped to CPU (because L4 is needed) When ACL is                                                                   \
		     disabled, if this bit is set, L2 forwarding as before, L3 \
		     above operation will trapped to CPU. When ACL is                                                                   \
		     disabled, if this bit is not set, IP fragment packet will \
		     be forwarded as normal via L3 routing or NAT. */
...
#define DisChk_CFI                                                             \
	(1 << 9) /* Disable Check CFI bit for L2 random packet testing         \
		    purpose. */
#define EnRRCP2CPU                                                             \
	(1                                                                     \
	 << 7) /* Enable trap RRCP packet to CPU port for L2 testing purpose.  \
		  RRCP: Realtek Remote Control Protocol (Proprietary) */
#define NATTM (1 << 6) /* 0: Normal mode processing, 1: NAT Test Mode */
#define Enable_ST                                                              \
	(1 << 5) /* Enable Spanning Tree Protocol. 0: disable, 1: enable */
...
#define STOP_TLU_STA                                                           \
	(1 << 19) /* (RO) Table Lookup Stop Status. 1-STOP_TLU command execute \
		     is ready */
...
#define EnUkVIDtoCPU                                                           \
	(1 << 15) /* Enable trap unknown tagged VID (VLAN table lookup miss)   \
		     packet to CPU */
#define NAPTF2CPU                                                              \
	(1 << 14) /*	Trap packets not in TCP/UDP/ICMP format and               \
							destined to the        \
		     interface required to do NAPT */
#define MultiPortModeP_OFFSET                                                  \
	(5) /* Multicast Port Mode : Internal (0) or External (1) */
#define MultiPortModeP_MASK                                                    \
	(0x1ff) /* {Ext3~Ext1,Port0~Port5} 0:Internal, 1:External */
...
#define EnNAPTRNotFoundDrop                                                    \
	(1 << 0) /* 0: Reverse NAPT entry not found to forward to CPU, 1:      \
		    Reverse NAPT entry not found to drop */
...
#define NAPTR_NOT_FOUND_DROP                                                   \
	EnNAPTRNotFoundDrop /* Reverse NAPT not found to S_DROP */
...
#define ENFRAGTOACLPT                                                          \
	(1 << 11) /* Enable fragment packet checked by ACL and protocol        \
		     trapper */
...
#define EN_SPI6_WAN_SRVPRT                                                     \
	(1 << 7)		  /* Enable SPI-6 between WAN and server port */
...
#define EnSPIRDrp                                                              \
	(1 << 1) /* Enable dropping packets not found by reverse SPI */
#define EN_DROP_SPIR_NOT_FOUND EnSPIRDrp /* Alias Name */
#define TrapSPIUnknown                                                         \
	(1 << 0) /* Enable SPI trapping non-TCP/UDP/ICMP packets */
...
#define INTExtP0_MASK                                                          \
	(7 << 18)	   /* Index for Ext0, pointing to Interface table */
#define INTExtP1_OFFSET 21 /* Index for Ext1, pointing to Interface table */
#define INTExtP1_MASK                                                          \
	(7 << 21)	   /* Index for Ext1, pointing to Interface table */
#define INTExtP2_OFFSET 24 /* Index for Ext2, pointing to Interface table */
#define INTExtP2_MASK                                                          \
	(7 << 24) /* Index for Ext2, pointing to Interface table */
...
#define IPMltCstCtrl_Disable                                                   \
	(0 << 3) /* Disable IP Multicast table lookup (just follow L2          \
		    Multicast packet procedure) */
#define IPMltCstCtrl_Enable (1 << 3) /* Enable IP Multicast table lookup */
#define IPMltCstCtrl_TrapToCpu                                                 \
	(2 << 3) /* Tral all IP Multicast packet to CPU port */
#define EN_MCAST IPMltCstCtrl_Enable /* Alias Name for Enable Multicast Table  \
				      */
#define EnFlood2NonCgtPrt                                                      \
	(1 << 2) /* Enable Flooding to non-Congested Port Only */
#define EnUnkUC2CPU                                                            \
	(1 << 1) /* Enable Unknown Unicast Packet Trap to CPU port */
#define EnUnkMC2CPU                                                            \
	(1 << 0) /* Enable Unknown Multicast Packet Trap to CPU port */
#define EN_UNUNICAST_TOCPU EnUnkUC2CPU /* Alias Name */
#define EN_UNMCAST_TOCPU EnUnkMC2CPU   /* Alias Name */

#define SBFCTR                                                                 \
	(0x4500 +                                                              \
	 SWCORE_BASE) /* System Based Flow Control Threshold Register */
...
#define PBFCR6 (0x024 + SBFCTR) /* Port Based Flow Control Threshold Register  \
				 */
#define QDBFCRP0G0                                                             \
	(0x028 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 0 Group 0 */
#define QDBFCRP0G1                                                             \
	(0x02C + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 0 Group 1 */
#define QDBFCRP0G2                                                             \
	(0x030 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 0 Group 2 */
#define QDBFCRP1G0                                                             \
	(0x034 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 1 Group 0 */
#define QDBFCRP1G1                                                             \
	(0x038 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 1 Group 1 */
#define QDBFCRP1G2                                                             \
	(0x03C + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 1 Group 2 */
#define QDBFCRP2G0                                                             \
	(0x040 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 2 Group 0 */
#define QDBFCRP2G1                                                             \
	(0x044 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 2 Group 1 */
#define QDBFCRP2G2                                                             \
	(0x048 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 2 Group 2 */
#define QDBFCRP3G0                                                             \
	(0x04C + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 3 Group 0 */
#define QDBFCRP3G1                                                             \
	(0x050 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 3 Group 1 */
#define QDBFCRP3G2                                                             \
	(0x054 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 3 Group 2 */
#define QDBFCRP4G0                                                             \
	(0x058 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 4 Group 0 */
#define QDBFCRP4G1                                                             \
	(0x05C + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 4 Group 1 */
#define QDBFCRP4G2                                                             \
	(0x060 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 4 Group 2 */
#define QDBFCRP5G0                                                             \
	(0x064 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 5 Group 0 */
#define QDBFCRP5G1                                                             \
	(0x068 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 5 Group 1 */
#define QDBFCRP5G2                                                             \
	(0x06C + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 5 Group 2 */
#define QDBFCRP6G0                                                             \
	(0x070 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 6 Group 0 */
#define QDBFCRP6G1                                                             \
	(0x074 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 6 Group 1 */
#define QDBFCRP6G2                                                             \
	(0x078 + SBFCTR) /* Queue-Descriptor=Based Flow Control Threshold for  \
			    Port 6 Group 2 */
#define QPKTFCRP0G0                                                            \
	(0x07C + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    0 Group 0 */
#define QPKTFCRP0G1                                                            \
	(0x080 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    0 Group 1 */
#define QPKTFCRP0G2                                                            \
	(0x084 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    0 Group 2 */
#define QPKTFCRP1G0                                                            \
	(0x088 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    1 Group 0 */
#define QPKTFCRP1G1                                                            \
	(0x08C + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    1 Group 1 */
#define QPKTFCRP1G2                                                            \
	(0x090 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    1 Group 2 */
#define QPKTFCRP2G0                                                            \
	(0x094 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    2 Group 0 */
#define QPKTFCRP2G1                                                            \
	(0x098 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    2 Group 1 */
#define QPKTFCRP2G2                                                            \
	(0x09C + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    2 Group 2 */
#define QPKTFCRP3G0                                                            \
	(0x0A0 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    3 Group 0 */
#define QPKTFCRP3G1                                                            \
	(0x0A4 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    3 Group 1 */
#define QPKTFCRP3G2                                                            \
	(0x0A8 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    3 Group 2 */
#define QPKTFCRP4G0                                                            \
	(0x0AC + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    4 Group 0 */
#define QPKTFCRP4G1                                                            \
	(0x0B0 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    4 Group 1 */
#define QPKTFCRP4G2                                                            \
	(0x0B4 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    4 Group 2 */
#define QPKTFCRP5G0                                                            \
	(0x0B8 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    5 Group 0 */
#define QPKTFCRP5G1                                                            \
	(0x0BC + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    5 Group 1 */
#define QPKTFCRP5G2                                                            \
	(0x0C0 + SBFCTR) /* Queue-Packet-Based Flow Control Register for Port  \
			    5 Group 2 */
...
#define S_DSC_RUNOUT_MASK                                                      \
	(0x3FF << 0) /* Mask for Descriptor Run Out Threshold */

/* SBFCR1 */
#define SDC_FCOFF_OFFSET                                                       \
	(16) /* Offset for system flow control turn off threshold */
#define SDC_FCOFF_MASK                                                         \
	(0x1ff << 16) /* Mask for system flow control turn off threshold */
#define SDC_FCON_OFFSET                                                        \
	(0) /* Offset for system flow control turn on threshold */
#define SDC_FCON_MASK                                                          \
	(0x1ff << 0) /* Mask for system flow control turn on threshold */

/* SBFCR2 */
#define S_Max_SBuf_FCOFF_OFFSET                                                \
	(16) /* System max shared buffer flow control turn off threshold */
#define S_Max_SBuf_FCOFF_MASK                                                  \
	(0x1FF                                                                 \
	 << 16) /* System max shared buffer flow control turn off threshold */
#define S_Max_SBuf_FCON_OFFSET                                                 \
	(0) /* System max shared buffer flow control turn on threshold */
#define S_Max_SBuf_FCON_MASK                                                   \
	(0x1FF                                                                 \
	 << 0) /* System max shared buffer flow control turn on threshold */

/* PBFCR0~PBFCR6 - Port Based Flow Control Threshold Register */
#define P_MaxDSC_FCOFF_OFFSET                                                  \
	(16) /* Per-Port Max Used Descriptor Flow Control Turn Off Threshold   \
	      */
#define P_MaxDSC_FCOFF_MASK                                                    \
	(0x1ff << 16) /* Per-Port Max Used Descriptor Flow Control Turn Off    \
			 Threshold */
#define P_MaxDSC_FCON_OFFSET                                                   \
	(0) /* Per-Port Max Used Descriptor Flow Control Turn On Threshold */
#define P_MaxDSC_FCON_MASK                                                     \
	(0x1ff << 0) /* Per-Port Max Used Descriptor Flow Control Turn On      \
			Threshold */

/* QoS Function Control Register */
#define OQNCR_BASE                                                             \
	(SWCORE_BASE + 0x4700)	   /* Output Queue Number Control Registers */
...
#define PBPCR                                                                  \
	(0x14 + OQNCR_BASE) /* Port Based Priority Control Register Address    \
			       Mapping */
#define UPTCMCR0                                                               \
	(0x18 + OQNCR_BASE) /* User Priority to Traffic Class Mapping for 1    \
			       output queue */
#define UPTCMCR1                                                               \
	(0x1c + OQNCR_BASE) /* User Priority to Traffic Class Mapping for 2    \
			       output queue */
#define UPTCMCR2                                                               \
	(0x20 + OQNCR_BASE) /* User Priority to Traffic Class Mapping for 3    \
			       output queue */
#define UPTCMCR3                                                               \
	(0x24 + OQNCR_BASE) /* User Priority to Traffic Class Mapping for 4    \
			       output queue */
#define UPTCMCR4                                                               \
	(0x28 + OQNCR_BASE) /* User Priority to Traffic Class Mapping for 5    \
			       output queue */
#define UPTCMCR5                                                               \
	(0x2c + OQNCR_BASE) /* User Priority to Traffic Class Mapping for 6    \
			       output queue */
#define LPTM8021Q                                                              \
	(0x30 +                                                                \
	 OQNCR_BASE) /*802.1Q priority to linear priority Transfer mapping.*/
#define DSCPCR0                                                                \
	(0x34 + OQNCR_BASE) /*DSCP Priority Control Register Address Mapping.  \
			     */
#define DSCPCR1                                                                \
	(0x38 + OQNCR_BASE) /*DSCP Priority Control Register Address Mapping.  \
			     */
#define DSCPCR2                                                                \
	(0x3C + OQNCR_BASE) /*DSCP Priority Control Register Address Mapping.  \
			     */
#define DSCPCR3                                                                \
	(0x40 + OQNCR_BASE) /*DSCP Priority Control Register Address Mapping.  \
			     */
#define DSCPCR4                                                                \
	(0x44 + OQNCR_BASE) /*DSCP Priority Control Register Address Mapping.  \
			     */
#define DSCPCR5                                                                \
	(0x48 + OQNCR_BASE) /*DSCP Priority Control Register Address Mapping.  \
			     */
#define DSCPCR6                                                                \
...
#define QIDDPCR                                                                \
	(0x50 +                                                                \
	 OQNCR_BASE) /*Queue ID Decision Priority Register Address Mapping*/
#define QNUMCR (0x54 + OQNCR_BASE) /*Queue Number Control Register*/
#define CPUQIDMCR0                                                             \
	(0x58 + OQNCR_BASE) /*CPU port QID Mapping Control Register            \
			       (DP=include CPU)*/
#define CPUQIDMCR1                                                             \
	(0x5C + OQNCR_BASE) /*CPU port QID Mapping Control Register            \
			       (DP=EXT0)*/
#define CPUQIDMCR2                                                             \
	(0x60 + OQNCR_BASE) /*CPU port QID Mapping Control Register            \
			       (DP=EXT1)*/
#define CPUQIDMCR3                                                             \
	(0x64 + OQNCR_BASE) /*CPU port QID Mapping Control Register            \
			       (DP=EXT2)*/
#define CPUQIDMCR4                                                             \
	(0x68 + OQNCR_BASE)	    /*CPU port QID Mapping Control Register    \
				       (DP=multi-port of Ext port)*/
...
#define P0Q0RGCR                                                               \
	(0x000 + PSCR) /* Rate Guarantee Control Register of Port 0 Queue 0 */
#define P0Q1RGCR                                                               \
	(0x004 + PSCR) /* Rate Guarantee Control Register of Port 0 Queue 1 */
#define P0Q2RGCR                                                               \
	(0x008 + PSCR) /* Rate Guarantee Control Register of Port 0 Queue 2 */
#define P0Q3RGCR                                                               \
	(0x00C + PSCR) /* Rate Guarantee Control Register of Port 0 Queue 3 */
#define P0Q4RGCR                                                               \
	(0x010 + PSCR) /* Rate Guarantee Control Register of Port 0 Queue 4 */
#define P0Q5RGCR                                                               \
	(0x014 + PSCR) /* Rate Guarantee Control Register of Port 0 Queue 5 */
#define P1Q0RGCR                                                               \
	(0x018 + PSCR) /* Rate Guarantee Control Register of Port 1 Queue 0 */
#define P1Q1RGCR                                                               \
	(0x01C + PSCR) /* Rate Guarantee Control Register of Port 1 Queue 1 */
#define P1Q2RGCR                                                               \
	(0x020 + PSCR) /* Rate Guarantee Control Register of Port 1 Queue 2 */
#define P1Q3RGCR                                                               \
	(0x024 + PSCR) /* Rate Guarantee Control Register of Port 1 Queue 3 */
#define P1Q4RGCR                                                               \
	(0x028 + PSCR) /* Rate Guarantee Control Register of Port 1 Queue 4 */
#define P1Q5RGCR                                                               \
	(0x02C + PSCR) /* Rate Guarantee Control Register of Port 1 Queue 5 */
#define P2Q0RGCR                                                               \
	(0x030 + PSCR) /* Rate Guarantee Control Register of Port 2 Queue 0 */
#define P2Q1RGCR                                                               \
	(0x034 + PSCR) /* Rate Guarantee Control Register of Port 2 Queue 1 */
#define P2Q2RGCR                                                               \
	(0x038 + PSCR) /* Rate Guarantee Control Register of Port 2 Queue 2 */
#define P2Q3RGCR                                                               \
	(0x03C + PSCR) /* Rate Guarantee Control Register of Port 2 Queue 3 */
#define P2Q4RGCR                                                               \
	(0x040 + PSCR) /* Rate Guarantee Control Register of Port 2 Queue 4 */
#define P2Q5RGCR                                                               \
	(0x044 + PSCR) /* Rate Guarantee Control Register of Port 2 Queue 5 */
#define P3Q0RGCR                                                               \
	(0x048 + PSCR) /* Rate Guarantee Control Register of Port 3 Queue 0 */
#define P3Q1RGCR                                                               \
	(0x04C + PSCR) /* Rate Guarantee Control Register of Port 3 Queue 1 */
#define P3Q2RGCR                                                               \
	(0x050 + PSCR) /* Rate Guarantee Control Register of Port 3 Queue 2 */
#define P3Q3RGCR                                                               \
	(0x054 + PSCR) /* Rate Guarantee Control Register of Port 3 Queue 3 */
#define P3Q4RGCR                                                               \
	(0x058 + PSCR) /* Rate Guarantee Control Register of Port 3 Queue 4 */
#define P3Q5RGCR                                                               \
	(0x05C + PSCR) /* Rate Guarantee Control Register of Port 3 Queue 5 */
#define P4Q0RGCR                                                               \
	(0x060 + PSCR) /* Rate Guarantee Control Register of Port 4 Queue 0 */
#define P4Q1RGCR                                                               \
	(0x064 + PSCR) /* Rate Guarantee Control Register of Port 4 Queue 1 */
#define P4Q2RGCR                                                               \
	(0x068 + PSCR) /* Rate Guarantee Control Register of Port 4 Queue 2 */
#define P4Q3RGCR                                                               \
	(0x06C + PSCR) /* Rate Guarantee Control Register of Port 4 Queue 3 */
#define P4Q4RGCR                                                               \
	(0x070 + PSCR) /* Rate Guarantee Control Register of Port 4 Queue 4 */
#define P4Q5RGCR                                                               \
	(0x074 + PSCR) /* Rate Guarantee Control Register of Port 4 Queue 5 */
#define P5Q0RGCR                                                               \
	(0x078 + PSCR) /* Rate Guarantee Control Register of Port 5 Queue 0 */
#define P5Q1RGCR                                                               \
	(0x07C + PSCR) /* Rate Guarantee Control Register of Port 5 Queue 1 */
#define P5Q2RGCR                                                               \
	(0x080 + PSCR) /* Rate Guarantee Control Register of Port 5 Queue 2 */
#define P5Q3RGCR                                                               \
	(0x084 + PSCR) /* Rate Guarantee Control Register of Port 5 Queue 3 */
#define P5Q4RGCR                                                               \
	(0x088 + PSCR) /* Rate Guarantee Control Register of Port 5 Queue 4 */
#define P5Q5RGCR                                                               \
	(0x08C + PSCR) /* Rate Guarantee Control Register of Port 5 Queue 5 */
#define P6Q0RGCR                                                               \
	(0x090 + PSCR) /* Rate Guarantee Control Register of Port 6 Queue 0 */
#define P6Q1RGCR                                                               \
	(0x094 + PSCR) /* Rate Guarantee Control Register of Port 6 Queue 1 */
#define P6Q2RGCR                                                               \
	(0x098 + PSCR) /* Rate Guarantee Control Register of Port 6 Queue 2 */
#define P6Q3RGCR                                                               \
	(0x09C + PSCR) /* Rate Guarantee Control Register of Port 6 Queue 3 */
#define P6Q4RGCR                                                               \
	(0x0A0 + PSCR) /* Rate Guarantee Control Register of Port 6 Queue 4 */
#define P6Q5RGCR                                                               \
	(0x0A4 + PSCR) /* Rate Guarantee Control Register of Port 6 Queue 5 */
#define WFQRCRP0                                                               \
	(0x0B0 + PSCR) /* Weighted Fair Queue Rate Control Register of Port 0  \
			*/
#define WFQWCR0P0                                                              \
	(0x0B4 + PSCR) /* Weighted Fair Queue Weighting Control Register 0 of  \
			  Port 0 */
#define WFQWCR1P0                                                              \
	(0x0B8 + PSCR) /* Weighted Fair Queue Weighting Control Register 1 of  \
			  Port 0 */
#define WFQRCRP1                                                               \
	(0x0BC + PSCR) /* Weighted Fair Queue Rate Control Register of Port 1  \
			*/
#define WFQWCR0P1                                                              \
	(0x0C0 + PSCR) /* Weighted Fair Queue Weighting Control Register 0 of  \
			  Port 1 */
#define WFQWCR1P1                                                              \
	(0x0C4 + PSCR) /* Weighted Fair Queue Weighting Control Register 1 of  \
			  Port 1 */
#define WFQRCRP2                                                               \
	(0x0C8 + PSCR) /* Weighted Fair Queue Rate Control Register of Port 2  \
			*/
#define WFQWCR0P2                                                              \
	(0x0CC + PSCR) /* Weighted Fair Queue Weighting Control Register 0 of  \
			  Port 2 */
#define WFQWCR1P2                                                              \
	(0x0D0 + PSCR) /* Weighted Fair Queue Weighting Control Register 1 of  \
			  Port 2 */
#define WFQRCRP3                                                               \
	(0x0D4 + PSCR) /* Weighted Fair Queue Rate Control Register of Port 3  \
			*/
#define WFQWCR0P3                                                              \
	(0x0D8 + PSCR) /* Weighted Fair Queue Weighting Control Register 0 of  \
			  Port 3 */
#define WFQWCR1P3                                                              \
	(0x0DC + PSCR) /* Weighted Fair Queue Weighting Control Register 1 of  \
			  Port 3 */
#define WFQRCRP4                                                               \
	(0x0E0 + PSCR) /* Weighted Fair Queue Rate Control Register of Port 4  \
			*/
#define WFQWCR0P4                                                              \
	(0x0E4 + PSCR) /* Weighted Fair Queue Weighting Control Register 0 of  \
			  Port 4 */
#define WFQWCR1P4                                                              \
	(0x0E8 + PSCR) /* Weighted Fair Queue Weighting Control Register 1 of  \
			  Port 4 */
#define WFQRCRP5                                                               \
	(0x0EC + PSCR) /* Weighted Fair Queue Rate Control Register of Port 5  \
			*/
#define WFQWCR0P5                                                              \
	(0x0F0 + PSCR) /* Weighted Fair Queue Weighting Control Register 0 of  \
			  Port 5 */
#define WFQWCR1P5                                                              \
	(0x0F4 + PSCR) /* Weighted Fair Queue Weighting Control Register 1 of  \
			  Port 5 */
#define WFQRCRP6                                                               \
	(0x0F8 + PSCR) /* Weighted Fair Queue Rate Control Register of Port 6  \
			*/
#define WFQWCR0P6                                                              \
	(0x0FC + PSCR) /* Weighted Fair Queue Weighting Control Register 0 of  \
			  Port 6 */
#define WFQWCR1P6                                                              \
	(0x100 + PSCR) /* Weighted Fair Queue Weighting Control Register 1 of  \
			  Port 6 */
#define LBPCR (0x104 + PSCR) /* Leaky Bucket Parameter Control Register */
#define LBTTCR                                                                 \
	(0x108 + PSCR) /* Leaky Bucket Token Threshold Control Register */
...
#define PBVCR0                                                                 \
	(0x1C + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Control Register 0      */
#define PBVCR1                                                                 \
	(0x20 + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Control Register 1      */
#define PBVR0_0                                                                \
	(0x24 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 0 -- IPX */
#define PBVR0_1                                                                \
	(0x28 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 0 -- IPX */
#define PBVR0_2                                                                \
	(0x2C + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 0 -- IPX */
#define PBVR0_3                                                                \
	(0x30 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 0 -- IPX */
#define PBVR0_4                                                                \
	(0x34 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 0 -- IPX */
#define PBVR1_0                                                                \
	(0x38 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 1 NetBIOS */
#define PBVR1_1                                                                \
	(0x3C + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 1 NetBIOS */
#define PBVR1_2                                                                \
	(0x40 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 1 NetBIOS */
#define PBVR1_3                                                                \
	(0x44 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 1 NetBIOS */
#define PBVR1_4                                                                \
	(0x48 + 0x4A00 + SWCORE_BASE) /* Protocol-Based VLAN Rule 1 NetBIOS */
#define PBVR2_0                                                                \
	(0x4C + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 2 PPPoE Control       */
#define PBVR2_1                                                                \
	(0x50 + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 2 PPPoE Control      */
#define PBVR2_2                                                                \
...
#define PBVR3_0                                                                \
	(0x60 + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 3 PPPoE session       */
#define PBVR3_1                                                                \
	(0x64 + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 3 PPPoE session      */
#define PBVR3_2                                                                \
...
#define PBVR4_0                                                                \
	(0x74 + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 4 User-defined 1       */
#define PBVR4_1                                                                \
	(0x78 + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 4 User-defined 1      */
#define PBVR4_2                                                                \
...
#define PBVR5_0                                                                \
	(0x88 + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 4 User-defined 2       */
#define PBVR5_1                                                                \
	(0x8C + 0x4A00 +                                                       \
	 SWCORE_BASE) /* Protocol-Based VLAN Rule 4 User-defined 2     */
#define PBVR5_2                                                                \
...
#define MiiTxPktRDY_OFFSET                                                     \
	10 /* Status flag of MII TX packet ready to send on port */
...
/* UART registers (used by boot/io/init.c) */
