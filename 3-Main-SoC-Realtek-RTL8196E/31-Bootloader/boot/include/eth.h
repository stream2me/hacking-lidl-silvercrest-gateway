...
enum SPEED { HALF_10 = 0, HALF_100 = 1, FULL_10 = 2, FULL_100 = 3 };
...
enum NIC_INTERRUPT_MASK {
	...
	RxOkMask = BIT(0),
	// WITHALLINT	=
	// BIT(10)|BIT(9)|BIT(8)|BIT(7)|BIT(6)|BIT(5)|BIT(4)|BIT(2)|BIT(0),
	// //8186
	WITHALLINT = BIT(10) | BIT(9) | BIT(8) | BIT(5) | BIT(4) | BIT(2) |
		     BIT(0), // wei test
	NOTXINT = BIT(10) | BIT(8) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(0),
	NORXINT = BIT(10) | BIT(9) | BIT(8) | BIT(7) | BIT(6),
	NOSWINT = BIT(9) | BIT(8) | BIT(7) | BIT(6) | BIT(5) | BIT(4) | BIT(2) |
		  BIT(0),
	NOLNKCHGINT = BIT(10) | BIT(9) | BIT(7) | BIT(6) | BIT(5) | BIT(4) |
		      BIT(2) | BIT(0),
	NOINT = 0,
};
...
enum NIC_IOCMD_REGISTERS {
	...
	TXFNL = BIT(1),
	TXFNH = BIT(0),
	CMD_CONFIG = RXINT_2 | RXTH_NO | TXINT_2 | TXTH_256 | TXENABLE |
		     RXENABLE, // 8186
	// CMD_CONFIG	= RXINT_4 | RXTH_64 | TXINT_8 | TXTH_128 | TXENABLE |
	// RXENABLE | RXTO_82, //8672
};
...
struct nic_default nicreg[] = {
    ...
    {regname : "NIC_ID1", offset : NIC_ID1, val : 0x00000000, access : word},
    {regname : "NIC_ID2", offset : NIC_ID2, val : 0x00000000, access : word},
    {regname : "NIC_MAR1", offset : NIC_MAR1, val : 0x00000000, access : word},
    {regname : "NIC_MAR2", offset : NIC_MAR2, val : 0x00000000, access : word},
    {regname : "NIC_TXOK", offset : NIC_TXOK, val : 0x0000, access : hword},
    {regname : "NIC_RXOK", offset : NIC_RXOK, val : 0x0000, access : hword},
    {regname : "NIC_TXERR", offset : NIC_TXERR, val : 0x0000, access : hword},
    {regname : "NIC_RXERR", offset : NIC_RXERR, val : 0x0000, access : hword},
    {regname : "NIC_RXMISS", offset : NIC_RXMISS, val : 0x0000, access : hword},
    {regname : "NIC_FAE", offset : NIC_FAE, val : 0x0000, access : hword},
    {regname : "NIC_TX1COL", offset : NIC_TX1COL, val : 0x0000, access : hword},
    {regname : "NIC_TXMCOL", offset : NIC_TXMCOL, val : 0x0000, access : hword},
    {regname : "NIC_RXPMOK", offset : NIC_RXPMOK, val : 0x0000, access : hword},
    {regname : "NIC_RXBROK", offset : NIC_RXBROK, val : 0x0000, access : hword},
    {regname : "NIC_RXMUOK", offset : NIC_RXMUOK, val : 0x0000, access : hword},
    {regname : "NIC_TXABT", offset : NIC_TXABT, val : 0x0000, access : hword},
    {regname : "NIC_TXUR", offset : NIC_TXUR, val : 0x0000, access : hword},

    {regname : "NIC_TRSR", offset : NIC_TRSR, val : 0x02, access : word},
    {regname : "NIC_CR", offset : NIC_CR, val : 0x00, access : byte},
    {regname : "NIC_IMR", offset : NIC_IMR, val : 0x0000, access : hword},
    {regname : "NIC_ISR", offset : NIC_ISR, val : 0x0000, access : hword},

    {regname : "NIC_TCR", offset : NIC_TCR, val : 0x00000000, access : word},

    {regname : "NIC_RCR", offset : NIC_RCR, val : 0x00000000, access : word},

    {regname : "NIC_MSR", offset : NIC_MSR, val : 0x00, access : byte},
