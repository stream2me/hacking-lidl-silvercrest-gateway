...
typedef struct _rtl865x_AclRule_s
{
	...
	uint32 ruleType_ : 5,
		...
		ratelimtIdx_ : 4;
		/* Index of rate limit table */ /* used as outputQueue index for 865xC qos system */
...
#define ETH_INTF_NUM 1  /* Single physical port configuration */
...
/* Netif management functions (added for 5.4 migration) */
