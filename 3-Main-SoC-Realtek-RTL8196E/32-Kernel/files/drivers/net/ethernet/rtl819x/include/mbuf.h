/*
 * RTL865x Packet Buffer Structures
 ...
 *
 * Packet header (pktHdr) and memory buffer (mBuf) structures for DMA.
 *
...
#define MBUF_SET_PKTHDRFLAGS(m, Flags)                                         \
	do                                                                         \
	{                                                                          \
		assert((m));                                                           \
...
#define MBUF_SET_PORTLIST(m, Portlist)           \
	do                                           \
	{                                            \
		assert((m));                             \
		assert(ISSET((m)->m_flags, MBUF_USED));  \
...
#define MBUF_SET_TRAPREASON(m, Reason)                                           \
	do                                                                           \
	{                                                                            \
		assert((m));                                                             \
		assert(ISSET((m)->m_flags, MBUF_USED));                                  \
