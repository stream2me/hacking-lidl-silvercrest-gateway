 ...
 *
 * ASIC specific register definitions for RTL865xC/RTL8196E.
 *
...
/* Type definitions for compatibility - only if not already defined */
#ifndef _RTL_TYPES_H
...
#define Pn_OQDSCR(port, queue)                                                                                                                                                                                                                                                                                                                                                                                              \
	(                                                                                                                                                                                                                                                                                                                                                                                                                       \
		((queue) == 0) || ((queue) == 1) ? ((queue & 0x01) ? ((READ_MEM32(Pn_DSCR0(port)) >> Pn_ODD_OQDSCR_OFFSET) & Pn_OQDSCR_MASK) : ((READ_MEM32(Pn_DSCR0(port)) >> Pn_EVEN_OQDSCR_OFFSET) & Pn_OQDSCR_MASK)) : ((queue) == 2) || ((queue) == 3) ? ((queue & 0x01) ? ((READ_MEM32(Pn_DSCR1(port)) >> Pn_ODD_OQDSCR_OFFSET) & Pn_OQDSCR_MASK) : ((READ_MEM32(Pn_DSCR1(port)) >> Pn_EVEN_OQDSCR_OFFSET) & Pn_OQDSCR_MASK)) \
																																																			   : ((queue) == 4) || ((queue) == 5)	? ((queue & 0x01) ? ((READ_MEM32(Pn_DSCR2(port)) >> Pn_ODD_OQDSCR_OFFSET) & Pn_OQDSCR_MASK) : ((READ_MEM32(Pn_DSCR2(port)) >> Pn_EVEN_OQDSCR_OFFSET) & Pn_OQDSCR_MASK)) \
																																																													: 0)
